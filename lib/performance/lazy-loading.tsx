...
export const LazyChartjs = lazyLoad(() => import('@/components/charts/chartjs'), {
  loading: <LoadingSkeleton rows={5} />,
});
...
export const RouteComponents = {
  ...
  InventoryDetails: lazyLoad(() => import('@/app/(dashboard)/inventory/[id]/page')),
  ...
  WarehouseDetails: lazyLoad(() => import('@/app/(dashboard)/warehouse/[id]/page')),
