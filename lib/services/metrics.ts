 ...
 */
export function trackIntegration(service: string, duration: number, success: boolean) {
 ...
 * Track voice command
 */
export function trackVoiceCommand(module: string, command: string, success: boolean) {
  voiceCommandsTotal.labels(module, command, success ? 'success' : 'error').inc();
}
