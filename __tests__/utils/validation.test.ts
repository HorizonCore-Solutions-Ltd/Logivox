...
describe('Form Validation Utilities', () => {
  describe('validateSKU', () => {
    ...
    it('should reject SKU with special characters', () => {
      expect(validateSKU('SKU@123')).toBe('SKU can only contain letters, numbers, and hyphens');
    });
    ...
    it('should reject SKU too long', () => {
      expect(validateSKU('A'.repeat(51))).toBe('SKU cannot exceed 50 characters');
    });
  });
  ...
  describe('validatePrice', () => {
    ...
    it('should reject more than 2 decimal places', () => {
      expect(validatePrice(10.999)).toBe('Price can have at most 2 decimal places');
    });
  ...
  describe('validateRequired', () => {
    ...
    it('should use custom field name', () => {
      expect(validateRequired('', 'Customer Name')).toBe('Customer Name is required');
    });
  });
  ...
  describe('validateDate', () => {
    ...
    it('should reject future dates when maxDate is today', () => {
      ...
      expect(validateDate(tomorrow.toISOString(), { maxDate: new Date() }))
    ...
    it('should reject past dates when minDate is today', () => {
      ...
      expect(validateDate(yesterday.toISOString(), { minDate: new Date() }))
