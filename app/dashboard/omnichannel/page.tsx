...
interface Order {
  ...
  fulfillmentMethod: 'ship-from-warehouse' | 'ship-from-store' | 'buy-online-pickup-in-store' | 'curbside';
...
export default function OmnichannelFulfillmentPage() {
  ...
  const channelData = [
    { channel: 'Web', orders: 1245, revenue: 98500, fulfillment: 94.5, avgTime: 2.3 },
    { channel: 'Store', orders: 567, revenue: 45600, fulfillment: 98.2, avgTime: 0.5 },
    { channel: 'Marketplace', orders: 892, revenue: 67800, fulfillment: 92.1, avgTime: 2.8 },
    { channel: 'Mobile App', orders: 734, revenue: 56700, fulfillment: 95.3, avgTime: 2.1 },
    { channel: 'B2B', orders: 234, revenue: 156000, fulfillment: 96.8, avgTime: 3.5 },
  ];
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Intelligent order routing across warehouses, stores, and fulfillment centers
        </p>
      </div>
        ...
        <TabsContent value="routing" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Orders being routed through intelligent algorithm</CardDescription>
                  </div>
                  <Button size="sm">
                ...
                <div className="space-y-3">
                  {orders.map((order) => (
                    <div key={order.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors">
                      ...
                      <div className="flex items-center gap-4">
                        <Badge variant={order.priority === 'Same-Day' ? 'destructive' : 'default'}>
                          {order.priority}
                        </Badge>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>AI-powered optimization metrics</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 border-t">
                  <div className="text-sm font-medium mb-3">Routing Factors:</div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Orders routed vs optimal routing today</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <Card key={node.id}>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold">{node.inventory.toLocaleString()}</div>
                      <div className="text-xs text-muted-foreground">Inventory</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold">{node.averageShipTime}d</div>
                      <div className="text-xs text-muted-foreground">Avg Ship Time</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold">${node.shippingCost}</div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-muted-foreground">{node.utilization}%</span>
                    </div>
        ...
        <TabsContent value="channels" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sales and fulfillment metrics by channel</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {channelData.map((channel, index) => (
                  <div key={channel.channel} className="p-4 border rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: `${COLORS[index]}20`, color: COLORS[index] }}>
                          {getChannelIcon(channel.channel.toLowerCase())}
                        </div>
                        <div>
                          <div className="font-medium">{channel.channel}</div>
                          <div className="text-sm text-muted-foreground">
                            {channel.orders} orders • ${channel.revenue.toLocaleString()} revenue
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="text-2xl font-bold text-green-600">{channel.fulfillment}%</div>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{channel.avgTime} days</div>
                      </div>
                      <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>How orders are being fulfilled</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">Ship-from-store growing</div>
                      <div className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">BOPIS performing well</div>
                      <div className="text-sm text-muted-foreground">
                        98.2% on-time pickup rate with high customer satisfaction
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-amber-50 dark:bg-amber-950 rounded-lg border border-amber-200 dark:border-amber-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">West Coast Hub under-utilized</div>
                      <div className="text-sm text-muted-foreground">
                        Consider routing more orders to WH-002 (currently at 42.9%)
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-purple-50 dark:bg-purple-950 rounded-lg border border-purple-200 dark:border-purple-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">Same-day delivery opportunity</div>
                      <div className="text-sm text-muted-foreground">
                        67% of orders could qualify for same-day with optimized routing
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <Card className="lg:col-span-2">
              <CardHeader>
                ...
                <CardDescription>Revenue and order volume by channel</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
