...
export default function DebitMemosPage() {
  ...
  const fetchStats = async () => {
    try {
      ...
      setStats({
        totalMemos: 52,
        totalAmount: 124580.00,
        pendingAmount: 48920.00,
        approvedAmount: 56340.00,
        paidAmount: 19320.00,
        disputedAmount: 5640.00,
        collectionRate: 68,
  ...
  const filteredMemos = debitMemos.filter(memo => {
    ...
    const matchesSearch = memo.memoNumber.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex gap-4 items-center">
        ...
        />
        <div className="flex gap-2">
          {['ALL', 'PENDING', 'APPROVED', 'DISPUTED', 'PAID', 'REJECTED'].map((status) => (
            <Button
              key={status}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{getReasonLabel(memo.reason)}</p>
                      </div>
                      <div>
      ...
      <Card className="bg-blue-50 border-blue-200">
        <CardContent className="pt-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-2">About Debit Memos</h3>
              <p className="text-sm text-blue-800">
                Debit memos are financial charges issued to vendors for operational failures such as late deliveries,
                short shipments, non-compliant packaging, or missing documentation. They serve as penalty charges
                that can be offset against future vendor payments.
              </p>
