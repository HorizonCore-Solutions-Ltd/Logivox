  ...
  const handleNext = () => {
    if (currentStep < 4) {
      ...
      setAnalysis((prev) => ({
        ...prev,
        rootCause:
          prev.why5.answer || "Root cause identified from 5 Why analysis",
      }));
    }
  };
          ...
          <Card>
            ...
            <CardContent>
              <Textarea
                ...
                onChange={(e) =>
                  setAnalysis({ ...analysis, problem: e.target.value })
                }
                rows={3}
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setAnalysis({ ...analysis, rootCause: e.target.value })
                    }
                    rows={3}
                    className="resize-none"
                  />
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setAnalysis({ ...analysis, category: value })
                    }
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      <SelectItem value="SUPPLIER_PROCESS">
                        Supplier Process
                      </SelectItem>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="flex gap-2">
                ...
                <p>
                  Stop when you reach the root cause (might be before 5 whys)
                </p>
              </div>
              <div className="flex gap-2">
