            ...
            <div className={`p-6 rounded-lg ${getRPNColor(rpn)} border-2`}>
              <div className="text-center">
                ...
                <div className="text-xl font-semibold mb-2">
                  {getRPNLevel(rpn)} RISK
                </div>
                <p className="text-sm">
                  {rpn >= 200 &&
                    "Immediate action required. Stop process if necessary."}
                  {rpn >= 125 &&
                    rpn < 200 &&
                    "Priority mitigation required within 30 days."}
                  {rpn >= 50 &&
                    rpn < 125 &&
                    "Mitigation recommended within 90 days."}
                  {rpn < 50 && "Monitor and review periodically."}
                </p>
                <p className="text-xs mt-2 opacity-75">
                  Formula: Severity ({severity}) × Occurrence ({occurrence}) ×
