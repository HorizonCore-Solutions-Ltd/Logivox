                    ...
                    {check.status !== "SCHEDULED" && (
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span
                            className={`text-lg font-bold ${getComplianceColor(check.complianceRate)}`}
                          >
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-3">
                          <div
                            className={`h-3 rounded-full ${
                              check.complianceRate >= 95
                                ? "bg-green-600"
                                : check.complianceRate >= 85
                                  ? "bg-blue-600"
                                  : check.complianceRate >= 75
                                    ? "bg-yellow-600"
                                    : "bg-red-600"
                            }`}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {new Date(
                            check.completedDate || check.scheduledDate,
                          ).toLocaleDateString()}
                        </p>
                      </div>
                    </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-cyan-800 mb-3">
                Compliance checks are systematic audits to verify that vendors
                meet required standards and regulations. These can include ISO
                certifications, FDA requirements, Good Manufacturing Practices
                (GMP), HACCP, or custom internal quality standards. Regular
                compliance auditing helps maintain quality consistency and
                reduces risk.
              </p>
