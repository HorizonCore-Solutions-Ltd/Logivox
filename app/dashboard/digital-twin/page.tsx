...
import { AreaChart, Area, BarChart, Bar, LineChart, Line, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, Radar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">950 <span className="text-sm font-normal text-muted-foreground">orders/day</span></div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">$12,500 <span className="text-sm font-normal text-muted-foreground">/day</span></div>
            <p className="text-xs text-muted-foreground">
        ...
        <TabsContent value="scenarios" className="space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {scenarios.map((scenario) => (
              <Card key={scenario.id} className={selectedScenario?.id === scenario.id ? 'border-primary' : ''}>
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      <div className="text-muted-foreground mb-1">Order Volume</div>
                      <div className="font-medium">{scenario.variables.orderVolume}/day</div>
                    </div>
                    <div>
                      <div className="text-muted-foreground mb-1">Staff Level</div>
                      <div className="font-medium">{scenario.variables.staffLevel} workers</div>
                    </div>
                    <div>
                      <div className="text-muted-foreground mb-1">Automation</div>
                      <div className="font-medium">{scenario.variables.automationLevel}%</div>
                    </div>
                    <div>
                      <div className="text-muted-foreground mb-1">Peak Factor</div>
                      <div className="font-medium">{scenario.variables.peakFactor}x</div>
                    </div>
                  </div>
                      ...
                      <div className="border-t pt-3">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="font-medium">{scenario.results.throughput}</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-muted-foreground">Utilization:</span>
                            <span className="font-medium">{scenario.results.utilization}%</span>
                          </div>
                          <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <span className="font-medium text-green-600">{scenario.results.accuracy}%</span>
                          </div>
                        </div>
                      </div>

                      <div className="flex gap-2">
                        <Button size="sm" className="flex-1" onClick={runSimulation}>
        ...
        <TabsContent value="realtime" className="space-y-4">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Real-time synchronization with physical warehouse</CardDescription>
                  </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Real-time capacity and utilization tracking</CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        <span className="text-muted-foreground">
                          Current: <span className="font-medium">{resource.current}%</span>
                        </span>
                        <span className="text-muted-foreground">
                          Optimal: <span className="font-medium text-blue-600">{resource.optimal}%</span>
                        </span>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Current vs Optimal vs Industry Average</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">Increase automation to 60%</div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">Optimize staff scheduling</div>
                      <div className="text-sm text-muted-foreground mb-2">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-purple-50 dark:bg-purple-950 rounded-lg border border-purple-200 dark:border-purple-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">Implement dynamic slotting</div>
                      <div className="text-sm text-muted-foreground mb-2">
                  ...
                  <div className="flex items-start gap-3 p-3 bg-amber-50 dark:bg-amber-950 rounded-lg border border-amber-200 dark:border-amber-800">
                    ...
                    <div>
                      <div className="font-medium text-sm">Add 2 dock doors</div>
                      <div className="text-sm text-muted-foreground mb-2">
        ...
        <TabsContent value="whatif" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Adjust variables to see predicted outcomes</CardDescription>
            </CardHeader>
                ...
                <div className="mt-6 p-4 bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="font-medium mb-2">Simulation Complete</div>
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          <div className="text-muted-foreground">Predicted Throughput:</div>
                          <div className="font-medium text-lg">
                            {Math.round(orderVolume[0] * 0.95)} orders/day
                          </div>
                        </div>
                        <div>
                          <div className="text-muted-foreground">Predicted Cost:</div>
                          <div className="font-medium text-lg">
                            ${Math.round(staffLevel[0] * 500 + (100 - automationLevel[0]) * 50)}
                          </div>
                        </div>
                        <div>
