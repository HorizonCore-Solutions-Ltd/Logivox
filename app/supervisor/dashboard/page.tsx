...
export default function AISupervisorDashboard() {
  ...
  const [selectedSession, setSelectedSession] =
    useState<SupervisionSession | null>(null);
  ...
  const avgAccuracy = sessions.length
    ? sessions.reduce((sum, s) => sum + (s.accuracyScore || 0), 0) /
      sessions.length
    : 0;
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-2 mb-3">
                      <div className="text-center">
                        <div
                          className={`text-lg font-bold ${getScoreColor(session.productivityScore)}`}
                        >
                      ...
                      <div className="text-center">
                        <div
                          className={`text-lg font-bold ${getScoreColor(session.accuracyScore)}`}
                        >
                      ...
                      <div className="text-center">
                        <div
                          className={`text-lg font-bold ${getScoreColor(session.safetyScore)}`}
                        >
                      ...
                      <div className="text-center">
                        <div
                          className={`text-lg font-bold ${getScoreColor(session.attentionScore)}`}
                        >
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span
                            className={`px-2 py-0.5 rounded text-xs font-semibold ${getSeverityColor(intervention.severity)}`}
                          >
