...
const MaintenanceSchema = z.object({
  maintenanceType: z.enum(['ROUTINE', 'REPAIR', 'CALIBRATION', 'BATTERY_REPLACEMENT', 'SOFTWARE_UPDATE', 'INSPECTION']),
  ...
  try {
    ...
    await prisma.equipment.update({
      ...
      data: {
        ...
        nextMaintenanceDate: body.nextDueDate ? new Date(body.nextDueDate) : null,
        ...(body.maintenanceType === 'REPAIR' && { status: 'AVAILABLE', condition: 'GOOD' }),
      },
    });
