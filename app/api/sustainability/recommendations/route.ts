      ...
      const sampleRecommendations = [
        {
          ...
          description: 'Replace virgin cardboard with 100% recycled cardboard for standard shipments',
        ...
        },
        {
          ...
          description: 'Use AI to select optimal box sizes, reducing void fill and materials',
        ...
        },
        {
          ...
          description: 'Replace plastic bubble wrap with biodegradable packing peanuts',
      ...
      return NextResponse.json({
        ...
        data: {
          ...
          summary: {
            ...
            applied: 0,
            totalPotentialCO2eSavings: sampleRecommendations.reduce((sum, r) => sum + r.co2eSavings, 0),
            totalPotentialCostSavings: sampleRecommendations.reduce((sum, r) => sum + r.costSavings, 0),
          },
        },
      });
    }
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        summary: {
          ...
          totalPotentialCO2eSavings: Math.round(totalPotentialCO2eSavings * 100) / 100,
          totalPotentialCostSavings: Math.round(totalPotentialCostSavings * 100) / 100,
        },
      },
    });
