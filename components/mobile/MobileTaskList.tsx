  ...
  return (
    <Box sx={{ p: 2, pb: 10 }}>
      ...
      <Card
        sx={{
          mb: 2,
          backgroundColor: OfflineSyncService.isOnline()
            ? "#e8f5e9"
            : "#fff3e0",
        }}
      >
      ...
      {error && (
        <Alert
          severity={error.includes("offline") ? "info" : "error"}
          sx={{ mb: 2 }}
        >
          {error}
        </Alert>
                ...
                <CardContent>
                  ...
                  {task.inventoryItem && (
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>{task.inventoryItem.sku}</strong> -{" "}
                  ...
                  >
                    ...
                    {task.fromLocation && (
                      <span>From: {task.fromLocation.name}</span>
                    )}
