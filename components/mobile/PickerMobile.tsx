    ...
    switch (action.type) {
      case "CONTAINER_ASSIGNED":
        ...
        setCurrentTask({
          type: "PICK_ITEM",
          instruction:
            "Container assigned. Start scanning or saying SKU numbers.",
      ...
      case "HELP_REQUESTED":
        setCurrentTask({
          type: "CONFIRM",
          instruction:
            "Help request sent. Continue working while help arrives.",
          data: currentTask.data,
        });
        break;
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-400">
          <div
            className={`w-2 h-2 rounded-full ${session ? "bg-green-500" : "bg-red-500"}`}
          />
