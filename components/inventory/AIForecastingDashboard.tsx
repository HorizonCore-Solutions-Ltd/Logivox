...
export default function AIForecastingDashboard({
  ...
  const [forecastDetail, setForecastDetail] = useState<ForecastData | null>(
    null,
  );
  ...
  const prepareChartData = () => {
    ...
    return forecastDetail.intelligence.predictions
      .slice(0, 30)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            95%+ accuracy AI-powered inventory predictions
          </p>
        </div>
      ...
      {accuracyReport && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {accuracyReport.summary?.avgAccuracy}
              </div>
              <Badge
                variant={
                  accuracyReport.summary?.metTarget ? "default" : "secondary"
                }
                className="mt-2"
              >
                Target: 95%+
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {accuracyReport.summary?.totalForecasts}
              </div>
            ...
            <CardContent>
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-semibold">
                  {accuracyReport.summary?.performance}
                </span>
              </div>
            </CardContent>
          </Card>
            ...
            {forecastDetail.intelligence.recommendations?.length > 0 && (
              <Alert className="mt-6">
                ...
                <AlertDescription>
                  ...
                  {forecastDetail.intelligence.recommendations[0].action}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Products with highest forecast accuracy
          </CardDescription>
        </CardHeader>
        <CardContent>
