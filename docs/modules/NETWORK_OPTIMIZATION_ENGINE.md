...
- **Logic**: Predicts stockouts based on velocity and triggers replenishment transfers from hubs *before* orders are missed.
...
```
**Outcome**:
If Primary FC is overloaded, system logs: *"Routing to Secondary FC (Load: 50) to avoid congestion at Primary (Load: 5000)."*
