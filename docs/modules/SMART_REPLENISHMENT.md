...
*   **Lead Time Analysis**: (Advanced) The system learns supplier lead times to order *before* you run out.
...
---
*Note: Manual creation of Draft POs is also supported via `Purchasing > New Order` for ad-hoc requests.*
