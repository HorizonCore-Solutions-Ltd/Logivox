...
POST: -create - grn - quality - control - complete - putaway - process - asn;
```

**2. Shipping API** (`/api/shipping/route.ts`)

```typescript
GET: -list - shipments - track - statistics;
...
```typescript
GET: -list - waves - pick - tasks - picker - performance - statistics;
...
```typescript
GET: -list - packs - cartons - stations - statistics;

POST: -create - pack - cartonize - start - packing - complete - pack;
```
...
_Architecture documented: January 2025_  
_System Version: 1.0.0_  
_Architecture Status: Production Ready_
