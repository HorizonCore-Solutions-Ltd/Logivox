# Product Roadmap: H1 2026 – H2 2027

## Current Status (Q1 2026)

**Launched Features**: Core WMS (inventory, picking, shipping, returns, quality, dock scheduling, voice operations, multi-tenant architecture)
**Stability**: Production-ready; 99.8% uptime SLA target
...
- **Demand Forecasting AI**: Time-series models for stock optimisation; "predict-to-stock" recommendations
...
- **Yard Management Enhancements**: Autonomous gate scheduling; driver communication automation
- **GDPR Privacy Controls**: Granular data retention policies; customer-initiated data deletion workflows
...
- **Mobile App v2**: Native iOS/Android app; offline picking with cloud sync
...
- **Sustainability Tracking**: Carbon footprint per shipment; ESG reporting for enterprise customers
- **API Rate Limiting v2**: Per-endpoint capacity management; reserved quotas for critical operations
...
- **AI-Driven Yard Scheduling**: Autonomous dock optimisation based on traffic patterns
...
- **APAC Expansion**: Singapore, Australia, Japan regional launches; localised compliance features
- **Ecosystem Integrations**: 50+ pre-built connectors (ERP, TMS, e-commerce, carriers, IoT)
...
- On-prem-only deployments (cloud-first strategy)
...
4. ✅ Cold-chain module (3 requests)
5. ✅ API improvements (7 requests)
...
- **Major Releases**: Quarterly (large features, breaking changes with 30-day deprecation notice)
- **Security Updates**: Ad-hoc; critical patches deployed within 24 hours of discovery
- **Scheduled Downtime**: Monthly maintenance window (Sunday 23:00–23:30 UTC); announced 2 weeks in advance

---

## Metrics We Track

- **Feature Adoption**: % of customers using each module (target: 70%+)
- **API Uptime**: Target 99.9% (monitored via synthetic tests)
- **Time-to-Value**: Days to first successful pick/shipment (target: ≤7 days)
- **Customer NPS**: Target ≥45 (industry benchmark 30–40)
- **Security Audit Findings**: Zero critical; <5 medium per annual audit
