...
Legacy WMS architecture was designed to assign tasks to *humans with barcode scanners*, not direct API payloads to robotic hardware. To bridge this gap, legacy vendors force you to purchase a **Warehouse Execution System (WES)**. 
...
At LogiVox, our philosophy is that a modern WMS *is* the Execution System. 
