<div style="text-align: center; margin-bottom: 20px;">
  <img src="file:///workspaces/Logivox/assets/brand/logos/logivox-logo-512.png" width="100" alt="LogiVox Logo" />
  <h1 style="color: #1a365d; font-family: Arial, sans-serif; font-size: 2em; margin-bottom: 0;">LogiVox Subscription Offerings</h1>
  <p style="color: #4a5568; font-size: 1.1em; font-family: Arial, sans-serif;">Predictable, Volume-Scale Pricing</p>
</div>
...
- Standard 8x5 Zendesk Email Support
...
- Advanced Priority Support (24x5)
...
- Designated Technical Account Manager (TAM) & 24/7 Support SLA

<br/>
<div style="text-align: center; margin-top: 40px; font-size: 0.9em; color: #718096; border-top: 1px solid #e2e8f0; padding-top: 15px;">
  <strong>Ready to upgrade your warehouse?</strong> Contact sales@logivox.com to discuss custom scaling discounts.
</div>
</div>
