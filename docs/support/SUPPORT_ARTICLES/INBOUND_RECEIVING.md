...
*Note: Generating Putaway tasks will instruct your forklift operators where to store the newly received inventory based on your facility's putaway logic.*
