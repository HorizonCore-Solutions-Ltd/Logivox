...
1. [Overview](#overview)
2. [New User Onboarding Checklist](#new-user-onboarding-checklist)
3. [Role-Specific Training Paths](#role-specific-training-paths)
4. [Day 1: Welcome & System Access](#day-1-welcome--system-access)
5. [Week 1: Core Training](#week-1-core-training)
6. [Week 2-4: Advanced Training](#week-2-4-advanced-training)
7. [Training Exercises](#training-exercises)
8. [Knowledge Assessment](#knowledge-assessment)
9. [Manager Onboarding Checklist](#manager-onboarding-checklist)
...
- **Basic Users**: 1 week
- **Warehouse Staff**: 2 weeks
- **Managers**: 3 weeks
- **Administrators**: 4 weeks
...
Please log in and change your password on your first day. For security, enable two-factor authentication (2FA) during your first login.
...
Your training buddy is [Mentor Name] - feel free to reach out with any questions!
...
- [ ] One-on-one with manager (feedback session)
...
- Use barcode scanners effectively
- Complete cycle counts
- Use mobile app for warehouse tasks
...
- Day 4: Inventory availability checks
...
4. Enter temporary password from welcome email
5. Click "Sign In"
...
- Pricing: Unit Cost vs. Selling Price
- Reorder settings
- Generate barcode
- Save product
...
- Product 4: Gadget Y (SKU: GDT-002)
...
- Add to category: Choose or create appropriate category
- Upload image (use sample images provided)
...
**Exercise 3: Create Sales Orders**
...
- Navigate warehouse efficiently
...
- Location codes explained (A-01-1-B-02)
...
- Scanner settings and troubleshooting
...
- Record scan times (goal: <2 seconds per scan)
...
- Time goal: Complete within 15 minutes
...
### Day 5: Reporting & Week 1 Assessment
...
- Speed and accuracy test (20 points)
...
- [ ] Notify team of new manager's arrival
...
- [ ] Meet direct reports (if applicable)
...
- [ ] Conduct performance review (if applicable)
...
4. Management and optimization (Month 3+)
...
- Meets daily during Week 1
- Available on-demand after Week 1
...
4. Did you feel prepared for your role?
5. How was the pacing of training?
6. How effective was your training buddy?
...
- Signed by manager and HR
- Professional design for framing
