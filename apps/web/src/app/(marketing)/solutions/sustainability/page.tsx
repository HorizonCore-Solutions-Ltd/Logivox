      ...
      <section className="relative py-20 lg:py-24 overflow-hidden border-b bg-muted/40">
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center text-center space-y-4 max-w-3xl mx-auto">
            <Badge
              variant="outline"
              className="w-fit mb-2 border-green-500/30 text-green-700 bg-green-500/10"
            >
            ...
            <p className="text-xl text-muted-foreground">
              Drive environmental impact reduction with enterprise-grade
              sustainability tracking. Monitor carbon footprints, optimize
              energy usage, and automate ESG reporting.
            </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our sustainability suite integrates directly with your warehouse
              operations to provide actionable insights into your environmental
              impact.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="h-full border-muted hover:border-green-500/30 transition-all hover:shadow-lg"
              >
                <CardHeader>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Track your progress towards Net Zero with real-time dashboards
                dedicated to environmental metrics. Ensure compliance with
                  ...
                  <CardContent>
                    <div className="grid grid-cols-3 gap-4">
                      {metric.kpis.map((kpi, j) => (
                        ...
                        >
                          <div
                            className={`text-xl font-bold ${kpi.status === "good" ? "text-green-600" : ""}`}
                          >
                            {kpi.value}
                          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-green-900 via-emerald-900 to-slate-900 text-white">
        <div className="container px-4 md:px-6 text-center">
          ...
          <p className="text-green-100 max-w-2xl mx-auto mb-8 text-lg">
            Join leading enterprises using LogiVox to reduce costs and
          ...
          <Button
            ...
            asChild
          >
            <Link href="/demo">Schedule a Sustainability Audit</Link>
          </Button>
        </div>
      </section>
    </div>
