...
export default function YardManagementPage() {
  ...
  const metrics = [
    { number: "65%", label: "Reduction in Truck Wait Times", description: "Pre-scheduled appointments eliminate unscheduled arrivals and yard queuing" },
    { number: "40%", label: "More Daily Dock Throughput", description: "Optimised shunter dispatch and appointment sequencing fills every dock slot" },
    { number: "95%", label: "Detention Fee Elimination", description: "Proactive dwell-time alerts fire before detention clocks expire" },
    { number: "< 60s", label: "Avg Gate Check-In Time", description: "Auto-linked appointments and digital gate log replace clipboard check-in" },
    { number: "100%", label: "Yard Visibility", description: "Live yard map accounts for every dock door, parking spot, and staging bay" },
    { number: "Zero", label: "Manual Shunter Radio Calls", description: "All dispatch handled digitally — tasks appear on driver mobile in real-time" },
  ];

  const comparisonRows = [
    { capability: "Live yard map (dock + parking + staging)", logivox: true, legacy: false },
    { capability: "Automated gate log with appointment auto-linking", logivox: true, legacy: false },
    { capability: "Security check recording per vehicle", logivox: true, legacy: false },
    { capability: "Shunter task auto-generation (PULL_TO_DOCK / SPOT_TRAILER)", logivox: true, legacy: false },
    { capability: "Detention fee countdown timer per task", logivox: true, legacy: false },
    { capability: "Urgent task escalation with visual badge", logivox: true, legacy: false },
    ...
    { capability: "Real-time UI (15s auto-refresh)", logivox: true, legacy: false },
    { capability: "Integrated with WMS inventory & GRN", logivox: true, legacy: false },
  ];
  ...
  const useCases = [
    {
      ...
      challenge: "Shunters were dispatched by radio. No one knew which trailers were ready to move. Detention costs were $40K/month.",
      outcome: "Task auto-generation eliminated radio dispatching. Detention costs dropped to <$2K/month in the first quarter.",
    },
    {
      title: "3PL Facility (Multi-Tenant Yard)",
      scenario: "Multiple customers sharing the same yard, tracked separately",
      challenge: "Gate staff manually matched paperwork to appointments. Mismatches caused security holds and delays.",
      outcome: "Automated appointment linking eliminated mismatches. Gate check-in time dropped from 8 minutes to 45 seconds.",
    },
    {
      title: "Retail DC — Peak Season",
      scenario: "350% volume surge during peak, same yard capacity",
      challenge: "Trailers were parked without records. Shunters couldn't locate trailers needed for dock pull. OTD suffered.",
      outcome: "Yard map gave supervisors instant trailer location visibility. OTD maintained at 98.5% through peak.",
    },
  ];
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden border-b bg-gradient-to-b from-blue-50 to-background py-20 md:py-32">
        <div className="container-enterprise relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-300" variant="outline">
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
              LogiVox Yard Management closes the gap between your TMS and WMS. Live yard map,
              automated gate check-in, AI-assisted shunter dispatch — every trailer accounts for
              itself from arrival to departure.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
              <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-green-500" />No detention fees</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-green-500" />Zero radio dispatching</span>
              <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-green-500" />Live for Enterprise customers today</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-enterprise">
          <div className="mb-12 text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              No add-ons, no integrations to maintain. Yard Management is built into the LogiVox platform and
              shares the same inventory, appointment, and carrier data as your WMS.
            </p>
          </div>
              ...
              <Card key={i} className="relative">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge className="bg-green-100 text-green-800 border-green-300 text-xs" variant="outline">{cap.badge}</Badge>
                  </div>
      ...
      <section className="py-20 border-t bg-muted/30">
        <div className="container-enterprise">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">The Yard Lifecycle, Automated</h2>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { step: "1", title: "Carrier Arrives at Gate", body: "Driver presents at gate. LogiVox captures vehicle/trailer number, driver name, carrier, and direction. Security inspection recorded. Auto-linked to matching dock appointment." },
              { step: "2", title: "Trailer Appears on Yard Map", body: "The trailer's parking spot lights up on the live yard map immediately after check-in. Supervisors see carrier, appointment type, and spot number in real-time." },
              { step: "3", title: "Shunter Task Auto-Generated", body: "When the appointment window approaches, LogiVox creates a PULL_TO_DOCK task. If urgency threshold is crossed, the task turns red with a countdown timer." },
              { step: "4", title: "Dock Done — Spot or Release", body: "After unload/load, a SPOT_TRAILER task sends the trailer back to parking or releases it to the gate. Yard map updates instantly. Appointment closes." },
            ].map((s, i) => (
      ...
      <section className="py-20 border-t">
        <div className="container-enterprise">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">LogiVox vs. Legacy YMS Solutions</h2>
            <p className="mt-4 text-muted-foreground">
              Most YMS systems bolt on to your WMS and cost $200K+ to integrate. LogiVox Yard Management is native.
            </p>
          </div>
              ...
              <table className="w-full text-sm">
                <thead className="bg-muted">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-center font-semibold text-blue-700">LogiVox</th>
                    <th className="px-4 py-3 text-center font-semibold text-gray-500">Legacy YMS</th>
                  </tr>
                </thead>
                <tbody>
                  {comparisonRows.map((row, i) => (
                    <tr key={i} className={i % 2 === 0 ? "bg-white" : "bg-muted/40"}>
                      ...
                      <td className="px-4 py-3 text-center">
                        {row.logivox ? <CheckCircle2 className="h-5 w-5 text-green-500 mx-auto" /> : <span className="text-gray-300">—</span>}
                      </td>
                      <td className="px-4 py-3 text-center">
                        {row.legacy ? <CheckCircle2 className="h-5 w-5 text-gray-400 mx-auto" /> : <span className="text-red-400 text-xs font-medium">✗ Not included</span>}
                      </td>
                    </tr>
                  ))}
                </tbody>
      ...
      <section className="py-20 border-t bg-muted/30">
        <div className="container-enterprise">
          <div className="mb-12 text-center">
            <Badge variant="outline" className="mb-4">Customer Outcomes</Badge>
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Real-World Impact</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {useCases.map((uc, i) => (
              <Card key={i} className="border-blue-200">
                <CardHeader>
                  <Badge className="w-fit mb-2 bg-blue-100 text-blue-800 border-blue-200" variant="outline">{uc.title}</Badge>
                  <CardDescription className="text-xs">{uc.scenario}</CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div>
                    <p className="text-xs font-semibold text-red-600 uppercase tracking-wide mb-1">Challenge</p>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{uc.outcome}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
      ...
      <section className="py-20 border-t">
        <div className="container-enterprise">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold">Yard Management Connects to the Whole Platform</h2>
            <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
              Gate check-ins update dock appointments instantly. Shunter dispatch pulls from WMS receiving schedules.
              Yard data feeds analytics. Nothing is siloed.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {[
              { label: "Dock & Receiving", href: "/solutions/warehouse-management", icon: Package },
              { label: "Labor Management", href: "/solutions/labor-management", icon: Zap },
              { label: "Robotics & AMR Fleet", href: "/solutions/warehouse-management", icon: GitMerge },
              { label: "IoT Sensor Network", href: "/platform/integrations", icon: Truck },
            ].map((m, i) => (
      ...
      <section className="border-t py-20 bg-blue-600 text-white">
        <div className="container-enterprise">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-3xl font-bold sm:text-4xl">Stop Paying Detention Fees. Start Today.</h2>
            <p className="mt-4 text-blue-100 text-lg">
              LogiVox Yard Management is included in the Enterprise plan. Go live in under two weeks with our
              guided onboarding team.
            </p>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <Button size="lg" className="bg-white text-blue-700 hover:bg-blue-50" asChild>
                <Link href="/contact">Schedule a Demo <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </Button>
