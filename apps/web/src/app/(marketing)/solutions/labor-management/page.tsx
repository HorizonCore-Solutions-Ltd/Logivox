  ...
  const features = [
    {
      ...
      description:
        "Digital time clock with clock in/out, break tracking, and overtime management.",
    },
    {
      icon: Activity,
      title: "Task Tracking",
      description:
        "Monitor task execution times, completion rates, and worker efficiency in real-time.",
    },
    {
      icon: BarChart3,
      title: "Productivity Analytics",
      description:
        "Performance dashboards with KPIs, trends, and benchmarking across workers and shifts.",
    },
    {
      icon: Target,
      title: "Labor Standards",
      description:
        "Engineered labor standards with expected vs actual time comparisons and variance analysis.",
    },
    {
      icon: DollarSign,
      title: "Cost Analysis",
      description:
        "Labor cost per unit, cost per order, and profitability analysis by client or SKU.",
    },
    {
      icon: Award,
      title: "Incentive Programs",
      description:
        "Performance-based incentives, gamification, and achievement tracking to boost morale.",
    },
  ];
  ...
  const metrics = [
    {
      ...
      kpis: [
        ...
        },
        {
          name: "Travel Time",
          value: "22%",
          benchmark: "25% typical",
          status: "good",
        },
        {
          name: "Lines per Hour",
          value: "42",
          benchmark: "35 standard",
          status: "good",
        },
      ],
    },
    {
      ...
      kpis: [
        {
          name: "Units Processed/Hr",
          value: "320",
          benchmark: "280 standard",
          status: "good",
        },
        {
          name: "Quality Check Rate",
          value: "98.5%",
          benchmark: "95% target",
          status: "good",
        },
      ...
      kpis: [
        {
          name: "Packs per Hour",
          value: "38",
          benchmark: "30 standard",
          status: "good",
        },
        {
          name: "Packing Accuracy",
          value: "99.8%",
          benchmark: "99.5% target",
          status: "good",
        },
        {
          name: "Carton Utilization",
          value: "87%",
          benchmark: "80% target",
          status: "good",
        },
  ...
  const timeClock = [
    {
      title: "Clock In/Out",
      description:
        "Simple mobile or terminal-based clock in/out with location verification",
      features: [
        "Face recognition",
        "PIN code",
        "Badge scan",
    ...
    },
    {
      ...
      description:
        "Automatic break tracking with compliance monitoring and alerts",
      features: [
        "Scheduled breaks",
        "Unpaid lunch",
        "Rest periods",
    ...
    },
    {
      ...
      description:
        "Flexible shift planning with skill-based assignment and availability management",
      features: [
        "Shift templates",
        "Skill matching",
        "Availability",
  ...
  const benefits = [
    {
      ...
      icon: TrendingUp,
      description:
        "Real-time visibility and performance tracking drives efficiency improvements",
    ...
    },
    {
      ...
      icon: DollarSign,
      description:
        "Optimized labor allocation and reduced overtime through better planning",
      stats: [
        "Reduced overtime: 18%",
        "Better allocation: $180K",
        "Lower turnover: $60K",
      ],
    },
    {
      ...
      stats: ["Industry avg: 94%", "LMS avg: 97%+", "Target: +3–5%"],
    },
    {
      title: "Reduced Turnover 42%",
      icon: Users,
      description:
        "Better work environment with fair performance measurement and incentives",
        ...
        <div className="container-enterprise relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Complete labor management with time tracking, performance
              analytics, task monitoring, and cost analysis. Increase
              productivity by 35% while reducing labor costs.
            </p>
        ...
        <div className="container-enterprise">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              Complete Labor Management Suite
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to track, analyze, and optimize warehouse
              workforce
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container-enterprise">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Industry-benchmarked outcomes for warehouses implementing modern
              LMS
            </p>
          </div>
