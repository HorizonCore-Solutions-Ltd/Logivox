  ...
  const services = [
    {
      ...
      description:
        "Custom labels, price tags, RFID tags, and compliance labeling (GS1, UPC, etc.).",
    },
    {
      icon: Package,
      title: "Kitting & Bundling",
      description:
        "Product bundling, promotional kits, subscription boxes, and gift sets.",
    },
    {
      icon: Palette,
      title: "Custom Packaging",
      description:
        "Branded packaging, gift wrapping, inserts, and marketing materials.",
    },
    {
      icon: FileText,
      title: "Documentation Services",
      description:
        "Packing slips, invoices, manuals, warranty cards, and custom inserts.",
    },
    {
      icon: Box,
      title: "Assembly & Manufacturing",
      description:
        "Light assembly, product customization, engraving, and embroidery.",
    },
    {
      icon: CheckCircle2,
      title: "Quality Inspection",
      description:
        "Pre-shipment inspection, testing, photography, and condition reporting.",
    },
  ];
        ...
        <div className="container-enterprise relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Labeling, kitting, custom packaging, assembly, and quality
              inspection services. Turn your warehouse into a profit center with
              value-added services.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild>
                <Link href="/contact?solution=vas">
