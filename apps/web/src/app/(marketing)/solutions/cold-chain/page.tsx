    ...
    <div className="min-h-screen">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" asChild>
                <Link href="/contact">See Cold Chain Demo</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 lg:py-28 bg-muted/30">
        <div className="container-enterprise">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">
              Comprehensive Cold Chain Modules
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Our Cold Chain platform delivers measurable improvements across
                your business.
              </p>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-primary-600 to-primary-500">
        <div className="container-enterprise text-center text-white">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Join leading companies using LogiVox Cold Chain to drive growth
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
