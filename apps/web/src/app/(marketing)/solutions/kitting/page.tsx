...
export const metadata: Metadata = {
  title:
    "Kitting & Assembly Operations | Build-to-Order Manufacturing - LogiVox",
  description:
    "Assemble products, create promotional bundles, and manage complex kitting operations. Voice-guided assembly with 99.5% accuracy and 40-60% faster completion.",
  keywords: [
    "kitting operations",
    "assembly management",
    "product bundling",
...
export default function KittingAssemblyPage() {
  const features = [
    {
      ...
      description:
        "Multi-level bill of materials with component tracking, substitutions, and version control.",
    ...
    },
    {
      ...
      description:
        "Dedicated workstations with digital work instructions, real-time guidance, and quality checkpoints.",
    ...
    },
    {
      ...
      description:
        "Hands-free voice instructions for component picking and assembly steps. Reduce errors and training time.",
    ...
    },
    {
      ...
      description:
        "Built-in QC checkpoints at each assembly stage. Photo documentation and defect tracking included.",
    ...
    },
    {
      ...
      description:
        "Automatic component allocation, shortage alerts, and substitute management. Track lot/serial genealogy.",
    ...
    },
    {
      ...
      description:
        "Time tracking per assembly step, productivity metrics, and labor cost analysis per kit.",
  ...
  const kitTypes = [
    ...
    },
    {
      ...
      description:
        "Build-to-order products with customer-specific configurations",
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-6 drop-shadow-sm">
              ...
              <span className="text-primary-600 block mt-2">
                With Voice-Guided Assembly
              </span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              Create promotional bundles, assemble custom products, and manage
              complex manufacturing kits. Voice guidance delivers 40-60% faster
              assembly with 99.5% accuracy.
            </p>
        ...
        <div className="container-enterprise">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-slate-300 max-w-2xl mx-auto">
              Voice-guided assembly with built-in quality checks. Start your
              free trial today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-slate-900 hover:bg-slate-100 text-lg"
                asChild
              >
                <Link href="/contact">
                  Start Free Trial
