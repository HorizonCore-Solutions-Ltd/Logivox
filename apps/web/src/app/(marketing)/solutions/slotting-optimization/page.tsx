  ...
  const benefits = [
    {
      ...
      value: "40%",
      description:
        "Cut down picker walking distance by placing high-velocity items in prime locations.",
    },
    {
      title: "Increase Storage Density",
      value: "25%",
      description:
        "Reclaim wasted space by matching SKU sizes to appropriate bin types automatically.",
    },
    {
      title: "Boost Pick Rate",
      value: "30%",
      description:
        "Faster picks mean more orders out the door per shift with the same workforce.",
    },
  ];
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center text-center space-y-6 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              ...
              Ideally place every pallet, case, and unit based on real-time
              velocity data and physical constraints.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button
                ...
                asChild
              >
                <Link href="/solutions/warehouse-management">Explore WMS</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Manual slotting with spreadsheets is obsolete. Our engine
              continuously analyzes thousands of data points to keep your
              warehouse optimized.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="flex-none bg-blue-100 p-2 rounded-full h-10 w-10 flex items-center justify-center text-blue-700 font-bold">
                    1
                  </div>
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      The system ingests your order history to calculate SKU
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      We verify product dimensions against bin capacities to
                      ensure a perfect physical fit.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Correction tasks are automatically generated for downtime,
                      guiding workers to move items to their optimal homes.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl p-8 aspect-square flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500 font-medium">
                  Interactive Slotting Heatmap Visualization
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container px-4 md:px-6 text-center">
          ...
          <Button
            ...
            asChild
          >
            <Link href="/contact">Talk to an Optimization Expert</Link>
          </Button>
        </div>
      </section>
    </div>
