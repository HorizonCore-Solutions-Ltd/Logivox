...
export const metadata: Metadata = {
  ...
  description: 'Eliminate storage with direct dock-to-dock transfers. Reduce handling costs by 40-60%, cut dwell time to under 4 hours, and accelerate order fulfillment.',
  keywords: ['cross-docking', 'dock to dock', 'flow-through distribution', 'transshipment', 'just-in-time logistics'],
}
...
export default function CrossDockingPage() {
  const features = [
    {
      ...
      description: 'Match inbound ASNs to outbound orders before arrival. Automatic allocation and dock door assignment.',
      metrics: '< 2 hours dwell time',
    },
    {
      icon: RefreshCw,
      title: 'Opportunistic Matching',
      description: 'Real-time AI matching of received goods to open orders. Identify cross-dock opportunities on the fly.',
      metrics: '85% match rate',
    },
    {
      icon: MapPin,
      title: 'Flow-Through Sorting',
      description: 'Voice-guided sorting direct from receiving to outbound staging. No intermediate storage required.',
      metrics: '95% first-time accuracy',
    },
    {
      icon: Clock,
      title: 'Dwell Time Monitoring',
      description: 'Real-time tracking of product dwell time. Automatic alerts when approaching time limits.',
      metrics: 'Max 4 hours',
    },
    {
      icon: Truck,
      title: 'Dock Door Management',
      description: 'Smart dock door allocation based on carrier, destination, and capacity. Minimize travel distance.',
      metrics: '30% faster loading',
    },
    {
      icon: BarChart3,
      title: 'Cross-Dock Analytics',
      description: 'Performance dashboards showing throughput, dwell time, cost savings, and efficiency metrics.',
  ...
  const crossDockTypes = [
    {
      type: 'Pre-Planned',
      description: 'Inbound shipments matched to outbound orders before arrival',
  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container-enterprise py-20 lg:py-28">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-6 drop-shadow-sm">
              Eliminate Storage
              <span className="text-primary-600 block mt-2">With Dock-to-Dock Flow</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl leading-relaxed">
              Transfer goods directly from receiving to shipping without storage. Reduce handling costs by 40-60%, cut dwell time to under 4 hours, and accelerate order fulfillment by 30%.
            </p>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="container-enterprise">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Complete Cross-Dock Solution</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              End-to-end dock-to-dock operations with AI-powered matching and real-time visibility
            </p>
          </div>
      ...
      <section className="py-20 lg:py-28 bg-slate-50">
        <div className="container-enterprise">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Cross-Docking Strategies</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                ...
                {[
                  {
                    ...
                    description: 'System receives advance shipment notification (ASN). AI matches inbound products to open outbound orders.',
                  },
                  {
                    icon: Truck,
                    title: 'Dock Receiving',
                    description: 'Carrier arrives at assigned receiving dock. Products scanned and verified against ASN. Quality checks performed.',
                  },
                  {
                    icon: RefreshCw,
                    title: 'Real-Time Sorting',
                    description: 'Voice-guided sorting to staging lanes. Products grouped by customer, route, or carrier. No storage required.',
                  },
                  {
                    icon: MapPin,
                    title: 'Staging & Consolidation',
                    description: 'Products staged at outbound dock doors. Multiple inbound shipments consolidated for single outbound load.',
                  },
                  {
                    icon: ShieldCheck,
                    title: 'Load Verification',
                    description: 'Final verification scan before loading. BOL generation and carrier documentation. Load sheet confirmation.',
                  },
                  {
                    icon: Zap,
                    title: 'Immediate Departure',
                    description: 'Outbound carrier loaded and departed. Total dwell time under 4 hours. Real-time tracking enabled.',
                  },
                ].map((step, index) => (
        ...
        <div className="container-enterprise">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-primary-100 max-w-2xl mx-auto">
              Eliminate storage and streamline operations with dock-to-dock cross-docking. Start your free trial today.
            </p>
