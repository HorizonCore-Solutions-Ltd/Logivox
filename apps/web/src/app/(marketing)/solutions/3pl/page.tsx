  ...
  const features = [
    {
      ...
      description:
        "Each client's data is completely segregated with no cross-contamination or visibility.",
    },
    {
      icon: DollarSign,
      title: "Client-Specific Billing",
      description:
        "Flexible billing models: per unit, per pallet, per order, or custom fee structures.",
    },
    {
      icon: Users,
      title: "Multi-Client Visibility",
      description:
        "Separate portals for each client with branded dashboards and custom reporting.",
    },
    {
      icon: FileText,
      title: "SLA Management",
      description:
        "Track and enforce client-specific SLAs with automated alerts and performance reporting.",
    },
    {
      icon: BarChart3,
      title: "Client Analytics",
      description:
        "Individual client dashboards with inventory, orders, and performance metrics.",
    },
    {
      icon: Settings,
      title: "Custom Workflows",
      description:
        "Client-specific processes, rules, and quality standards within shared warehouse.",
    },
  ];
        ...
        <div className="container-enterprise relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-8">
              Complete client segregation, flexible billing, branded portals,
              and SLA management. Manage unlimited clients in one warehouse with
              enterprise-grade security.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" asChild>
                <Link href="/contact?solution=3pl">
