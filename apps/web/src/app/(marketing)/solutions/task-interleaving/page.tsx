      ...
      <section className="relative py-20 lg:py-24 overflow-hidden border-b bg-muted/40">
        <div className="container px-4 md:px-6 relative z-10">
          <div className="flex flex-col items-center text-center space-y-4 max-w-3xl mx-auto">
            <Badge
              variant="outline"
              className="w-fit mb-2 border-blue-500/30 text-blue-700 bg-blue-500/10"
            >
            ...
            <p className="text-xl text-muted-foreground">
              Maximize every movement in your warehouse. Combine tasks, optimize
              routes, and eliminate deadheading with AI-powered task
              orchestration.
            </p>
        ...
        <div className="container px-4 md:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Move beyond simple FIFO queues. LogiVox analyzes thousands of
              variables in real-time to assign the most efficient next task to
              every worker.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="h-full border-muted hover:border-blue-500/30 transition-all hover:shadow-lg"
              >
                <CardHeader>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Task interleaving transforms your operational data into tangible
                efficiency gains. Watch productivity soar as wasted motion
                disappears.
              </p>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-3 gap-4">
                      {metric.kpis.map((kpi, j) => (
                        ...
                        >
                          <div
                            className={`text-xl font-bold ${kpi.status === "good" ? "text-blue-600" : ""}`}
                          >
                            {kpi.value}
                          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-900 via-indigo-900 to-slate-900 text-white">
        <div className="container px-4 md:px-6 text-center">
          ...
          <p className="text-blue-100 max-w-2xl mx-auto mb-8 text-lg">
            Activate task interleaving today and unlock hidden capacity in your
            existing workforce.
          </p>
          <Button
            size="lg"
            ...
            asChild
          >
            <Link href="/demo">Calculate Your Savings</Link>
          </Button>
        </div>
      </section>
    </div>
