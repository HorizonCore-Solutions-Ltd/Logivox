...
const COOKIE_CATEGORIES = [
  {
    ...
    badge: "Required",
    description:
      "These cookies are essential for the website to function and cannot be switched off. They are used to authenticate users, prevent fraud, and maintain security.",
    examples: [
  ...
  },
  {
    ...
    badge: "Optional",
    description:
      "These cookies help us understand how visitors interact with our website so we can improve our service.",
    examples: [
      "Page view counts",
  ...
  },
  {
    ...
    badge: "Optional",
    description:
      "These cookies enable enhanced functionality and personalisation. They may be set by us or by third parties whose services we have added to our pages.",
    examples: [
  ...
  },
  {
    ...
    badge: "Optional",
    description:
      "These cookies may be set through our website by our advertising partners to build a profile of your interests.",
      ...
      <main className="max-w-5xl mx-auto px-6 py-16 space-y-12">
        ...
        <section className="prose max-w-none space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            better user experience. Some cookies are essential for the website
            to function properly, while others help us improve our services and
            ...
            {COOKIE_CATEGORIES.map((cat) => (
              <div key={cat.name} className="border rounded-xl p-6 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <Badge
                    variant={cat.badge === "Required" ? "default" : "secondary"}
                  >
                    {cat.badge}
                  </Badge>
                </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            Most browsers allow you to block all or specific types of cookies.
            Note that blocking strictly necessary cookies may prevent you from
            using parts of our service.
          </p>
          <p className="text-muted-foreground leading-relaxed">
