  ...
  const challenges = [
    {
      ...
      solution:
        "Real-time visibility into supplier inventory and transit status",
    },
    {
      icon: Gauge,
      title: "Complex Parts Hierarchy",
      description:
        "Thousands of SKUs with sub-assemblies, BOMs, and lot tracking",
    ...
    },
    {
      ...
      solution:
        "Complete lot tracking with test documentation and certificates",
    },
    {
      icon: Clock,
  ...
  const solutions = [
    {
      ...
      description:
        "Real-time connection to supplier systems and inventory levels",
      benefits: [
        "Live supplier inventory",
        "Automated EDI orders",
    ...
    <div className="min-h-screen">
        ...
        <div className="container-enterprise">
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Synchronize complex supply chains across multiple suppliers and
              production lines. Real-time visibility, intelligent scheduling,
              and IATF compliance. Reduce inventory 60% while improving on-time
              delivery to 98.5%.
            </p>
            ...
            <CardContent className="pt-8">
              <div className="space-y-4">
                <p className="text-lg italic">
                  "LogiVox transformed our supply chain from chaotic to
                  synchronized. We reduced inventory by 60% while hitting 98.5%
                  on-time delivery. Line stoppages basically disappeared. IATF
                  audits are effortless now."
                </p>
                <div>
                  <p className="font-semibold">Marcus Rodriguez</p>
                  <p className="text-sm text-muted-foreground">
                    VP of Operations, Precision Automotive Supply
                  </p>
                </div>
              </div>
            </CardContent>
      ...
      <section className="py-20">
        <div className="container-enterprise text-center space-y-6">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Real-time visibility. Intelligent scheduling. IATF compliance. 98.5%
            on-time delivery with 60% lower inventory.
          </p>
