  ...
  const challenges = [
    {
      ...
      description: "Managing 20+ different customer requirements on one WMS platform",
      solution: "Multi-tenant architecture isolates each customer's data and processes",
    },
    {
      icon: Warehouse,
      title: "Complex Operations at Scale",
      description: "Juggling receiving, putaway, picking, packing, shipping for dozens of customers",
      solution: "Automated workflows handle unlimited complexity as you grow",
    },
    {
      icon: TrendingUp,
      title: "Profitability Pressure",
      description: "Thin margins require maximum efficiencyo to stay profitable",
      solution: "35% productivity increase with voice ops directly improves bottom line",
    },
    {
      icon: AlertCircle,
      title: "Compliance & Audit Risk",
      description: "Multiple certifications required (GDPR, HIPAA, SOC 2) for different customers",
      solution: "Built-in compliance automation meets all requirements simultaneously",
    },
  ];
  ...
  const solutions = [
    {
      ...
      benefits: ["Customer data separation", "Custom workflows per customer", "Billing per customer", "100% audit trail"],
    ...
    },
    {
      ...
      benefits: ["Customer portal", "Live tracking", "Automated alerts", "EDI integration"],
    ...
    },
    {
      ...
      benefits: ["GDPR ready", "HIPAA certified", "SOC 2 audited", "Compliance reports"],
    ...
    },
    {
      ...
      benefits: ["Add customers instantly", "No infrastructure costs", "Per-customer billing", "Margin improvement"],
      roi: "Revenue growth without cost scaling",
    },
  ];

  const metrics = [
    { label: "Customers Supported", before: "5-10", after: "50+", improvement: "10x capacity" },
    { label: "Operational Cost", before: "$8/order", after: "$2.50/order", improvement: "-69%" },
    { label: "Processing Time", before: "4 hours", after: "1 hour", improvement: "-75%" },
    { label: "System Complexity", before: "Multiple WMS", after: "Single unified", improvement: "90% simpler" },
    { label: "Customer Satisfaction", before: "85%", after: "98%", improvement: "+13 pts" },
    { label: "Audit Pass Rate", before: "60%", after: "100%", improvement: "100% compliant" },
  ];
        ...
        <div className="container-enterprise">
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Multi-tenant WMS built for 3PLs. Support unlimited customers with complete data isolation,
              automated compliance, and margins that actually improve as you grow. Real-time visibility means
              happy customers and fewer support calls.
            </p>
        ...
        <div className="container-enterprise">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Different customers, different requirements. One platform that handles it all.
            </p>
          </div>
            ...
            <CardContent className="pt-12">
              <blockquote className="space-y-6 text-center">
                <p className="text-xl font-semibold italic">
                  "We're a 3PL with 30 customers, each with different requirements. 
                  Trying to manage them on separate systems was killing our margins.
                  With LogiVox's multi-tenant architecture, we run everyone on one platform.
                  Our per-order cost dropped 69%. Our customers get real-time visibility they love.
                  Our profit margins finally make sense."
                </p>
                <div>
                  <p className="font-bold">Robert Chen</p>
                  <p className="text-muted-foreground">VP Operations, TechGear Logistics</p>
                  <p className="text-sm font-semibold text-green-600 pt-2">30 customers • $2.50/order • 98% satisfaction</p>
                </div>
              </blockquote>
            </CardContent>
          </Card>
