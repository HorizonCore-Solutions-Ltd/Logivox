  ...
  const challenges = [
    {
      ...
      description:
        "FEFO (First Expired, First Out) complex to manage manually - risk of recalls",
      solution:
        "Automatic expiration date tracking with FEFO prioritization prevents waste",
    },
    {
      icon: TrendingUp,
      title: "Temperature Control",
      description:
        "Maintain proper temps from receiving through delivery or product is ruined",
      solution:
        "Alerts and automated workflows ensure temperature-controlled logistics",
    },
    {
      icon: AlertCircle,
      title: "Regulatory Compliance",
      description:
        "FDA, GSMA, and local regulations require meticulous documentation",
      solution:
        "Audit trails and compliance reporting meet all regulatory requirements",
    },
    {
      icon: Lock,
      title: "Food Safety & Recalls",
      description:
        "Trace ingredients back to source; trace recalls to all locations",
  ...
  const metrics = [
    {
      ...
      before: "8-12%",
      after: "1-2%",
      improvement: "-87% waste",
    },
    {
      label: "Expiration Misses",
      before: "0.5-1%",
      after: "<0.01%",
      improvement: "98% elimination",
    },
    {
      label: "Recall Time",
      before: "3-5 days",
    ...
    <div className="min-h-screen">
        ...
        <div className="container-enterprise">
          <div className="text-center space-y-6 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              LogiVox automates FEFO, tracks expiration dates, ensures
              temperature control, and makes recalls instant. FDA/GSMA
              compliant. Execute recalls in 2 hours instead of 3 days. Zero
              recalls means zero liability.
            </p>
        ...
        <div className="container-enterprise">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              F&B operations have unique requirements around freshness, safety,
              and compliance
            </p>
          </div>
        ...
        <div className="container-enterprise">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Real improvements in waste reduction, compliance, and recall
              readiness
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-enterprise text-center space-y-6">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            FDA/GSMA compliant platform. Execute recalls in 2 hours. Zero
            recalls on your watch.
          </p>
