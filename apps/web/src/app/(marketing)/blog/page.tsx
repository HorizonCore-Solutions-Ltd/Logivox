...
export default function BlogPage() {
  ...
  const featuredPost = {
    ...
    title:
      "Implementing Zero-Trust Security in Enterprise Inventory Management",
    excerpt:
      "Learn how zero-trust architecture transforms security in modern inventory systems, protecting your data at every level.",
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "How we built real-time synchronization across thousands of concurrent users without compromising performance.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to integrating your warehouse management system with major ERP platforms.",
    ...
    },
    {
      ...
      excerpt:
        "Discover how machine learning and AI are revolutionizing inventory management and demand forecasting.",
    ...
    },
    {
      ...
      excerpt:
        "Best practices for creating progressive web applications that work seamlessly offline with service workers.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how we optimize PostgreSQL for handling millions of inventory transactions with sub-second response times.",
    ...
    },
    {
      ...
      excerpt:
        "Streamline your reverse logistics process with efficient RMA workflows and automated processing.",
    ...
    },
    {
      ...
      excerpt:
        "Advanced strategies for optimizing wave picking operations and reducing pick times in large warehouses.",
          ...
          <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
            <CardHeader className="text-center max-w-2xl mx-auto">
              ...
              <CardDescription className="text-base mb-6">
                Get the latest articles, product updates, and industry insights
                delivered directly to your inbox. Join 5,000+ warehouse
                professionals.
              </CardDescription>
