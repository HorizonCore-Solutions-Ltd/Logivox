...
export const metadata: Metadata = {
  ...
  description:
    "LogiVox Privacy Policy - How we collect, use, and protect your data. GDPR and CCPA compliant.",
};
      ...
      <section className="border-b bg-muted/50 py-16">
        <div className="container-enterprise">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl">
            Your privacy is important to us. This policy explains how LogiVox
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                LogiVox ("we," "our," or "us") is committed to protecting your
                privacy and ensuring the security of your personal information.
                This Privacy Policy explains how we collect, use, disclose, and
                safeguard your information when you use our enterprise stock
                booking and inventory management platform.
              </p>
              <p className="text-muted-foreground">
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  ...
                  team member information, supplier/customer data
                </li>
                <li>
                  <strong>Inventory Data:</strong> Product information, stock
                  levels, warehouse locations, pricing
                </li>
                <li>
                  <strong>Transaction Data:</strong> Booking records, inventory
                  movements, order history
                </li>
                <li>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  <strong>Log Data:</strong> Access times, error logs, security
                  events
                </li>
                <li>
                  <strong>Voice Data:</strong> Voice command recordings when
                  using our voice control feature (processed locally, not
                  stored)
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  <strong>ERP Integration Data:</strong> Data synchronized from
                  Oracle, SAP, NetSuite, or other ERP systems
                </li>
                <li>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  Train AI/ML models for inventory forecasting (aggregated,
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  <strong>Cloud Infrastructure:</strong> AWS, Google Cloud, or
                ...
                <li>
                  <strong>Email Services:</strong> SendGrid, AWS SES for
                  transactional emails
                </li>
                <li>
                  <strong>Monitoring:</strong> Sentry, Datadog for error
              ...
              <p className="text-muted-foreground">
                Data is shared with authorized users within your organization
                according to your configured role-based access controls.
              </p>
              ...
              <p className="text-muted-foreground">
                ...
                order, or governmental request, or to protect our rights and
                safety.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  <strong>Access Control:</strong> Multi-factor authentication,
                  role-based permissions, zero-trust architecture
                </li>
                <li>
                  <strong>Infrastructure:</strong> SOC 2 Type II compliant
                  hosting, regular security audits
                </li>
                <li>
                ...
                <li>
                  <strong>Data Isolation:</strong> Complete tenant isolation,
                ...
                <li>
                  <strong>Incident Response:</strong> Dedicated security team,
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                <a
                  href="mailto:privacy@logivox.ai"
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  ...
                  active, plus 90 days after deletion
                </li>
                <li>
                ...
                <li>
                  <strong>Audit Logs:</strong> 3 years for security and
                  compliance
                </li>
                <li>
                ...
                <li>
                  <strong>Backups:</strong> 90 days in encrypted backup storage
                </li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>
                  Regional data residency options available for enterprise
                  customers
                </li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                LogiVox is a business-to-business (B2B) platform not intended
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                notice on our platform. Your continued use of LogiVox after
