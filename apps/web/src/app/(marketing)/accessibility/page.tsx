...
export const metadata: Metadata = {
  ...
  description:
    "LogiVox Accessibility Statement - Our commitment to WCAG 2.1 AA compliance and inclusive design.",
};
      ...
      <section className="border-b bg-muted/50 py-16">
        <div className="container-enterprise">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl">
            LogiVox is committed to ensuring digital accessibility for all
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                LogiVox is dedicated to providing an inclusive and accessible
                experience for all users, regardless of ability or disability.
                We believe that everyone should be able to manage inventory,
                create bookings, and access reports with ease.
              </p>
              <p className="text-muted-foreground">
                We continuously work to enhance the accessibility of our
                platform and ensure compliance with the Web Content
                Accessibility Guidelines (WCAG) 2.1 Level AA, Section 508 of the
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      LogiVox conforms to WCAG 2.1 Level AA standards
                    </p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
                  <strong>Conformance Status:</strong> Fully Conformant - The
                  content fully conforms to the accessibility standard without
                  any exceptions.
                </p>
              </div>
              <p className="text-muted-foreground">
                This means LogiVox meets all Level A and Level AA success
                criteria of the Web Content Accessibility Guidelines 2.1,
                ensuring our platform is perceivable, operable, understandable,
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="border rounded-lg p-6">
                  ...
                  <p className="text-muted-foreground mb-3">
                    Industry-first voice control feature for hands-free
                    operation.
                  </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                LogiVox supports numerous keyboard shortcuts for efficient
                navigation. Press{" "}
                ...
                anywhere in the app to view all available shortcuts.
              </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                LogiVox has been tested with and supports the following
                assistive technologies:
              </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                LogiVox is designed to work with the following browsers and
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  • <strong>HTML:</strong> Semantic HTML5 elements
                </li>
                <li>
                  • <strong>WAI-ARIA:</strong> Accessible Rich Internet
                  Applications specifications
                </li>
                <li>
                  • <strong>CSS:</strong> Responsive design, focus management,
                  reduced motion queries
                </li>
                <li>
                  • <strong>JavaScript:</strong> Keyboard event handling, ARIA
                  live regions, focus trap
                </li>
                <li>
                  • <strong>Web Speech API:</strong> Voice control functionality
                </li>
              </ul>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                Despite our efforts, there may be some limitations. We are
                actively working to address the following:
              </p>
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  • Some complex charts may have limited screen reader support
                  (alternative data tables provided)
                </li>
                <li>
                  • Voice control requires modern browser with Web Speech API
                  support
                </li>
                <li>
                  • PDF exports may have variable accessibility depending on
                  content
                </li>
              </ul>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground mt-4">
                <strong>Last Audit Date:</strong> October 1, 2025
                <br />
                <strong>Audit Firm:</strong> AccessibilityWorks Inc.
                <br />
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                LogiVox. Our ongoing efforts include:
              </p>
              <ul className="space-y-1 text-muted-foreground">
                <li>• Regular accessibility audits and testing</li>
                <li>
                  • Training for development team on accessibility best
                  practices
                </li>
                <li>
            ...
            <div id="contact" className="mb-12">
              ...
              <p className="text-muted-foreground mb-4">
                We welcome your feedback on the accessibility of LogiVox. If you
              ...
              <div className="bg-muted p-6 rounded-lg">
                ...
                <p className="text-muted-foreground mt-4">
                  ...
                  days and to implement necessary changes within 30 days.
                </p>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                If you wish to file a formal complaint about LogiVox's
                accessibility:
              </p>
              <ol className="space-y-2 text-muted-foreground list-decimal list-inside">
                <li>Contact our Accessibility Team (details above)</li>
                <li>
                  If not satisfied, contact our Accessibility Officer at{" "}
                  <a
                    href="mailto:accessibility-officer@logivox.ai"
                    className="text-primary hover:underline"
                  >
                    accessibility-officer@logivox.ai
                  </a>
                </li>
                <li>
                  For further escalation, you may file a complaint with:
