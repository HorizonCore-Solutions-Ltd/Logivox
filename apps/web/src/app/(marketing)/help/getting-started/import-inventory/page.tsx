...
import { ArrowLeft, ArrowRight, CheckCircle2, FileSpreadsheet, AlertTriangle, Lightbulb } from "lucide-react"

export const metadata: Metadata = {
  title: "Import Initial Inventory | LogiVox Help Center",
  description: "Learn how to import your product catalog and inventory data via CSV or API integration.",
}
    ...
    <div className="flex flex-col min-h-screen">
      <section className="bg-gradient-to-b from-primary-50 to-white border-b py-8">
        <div className="container-enterprise max-w-4xl">
          ...
          <h1 className="text-4xl font-bold mb-4">Import Your Initial Inventory</h1>
          <p className="text-xl text-muted-foreground">
            Upload your product catalog and inventory data using CSV import or API integration.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container-enterprise max-w-4xl">
          <Alert className="mb-8">
            ...
            <AlertDescription>
              Ensure you have completed warehouse setup and configured your storage locations. You'll assign inventory to these locations during import.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Upload a spreadsheet with your product and inventory data. Best for one-time imports or manual updates.
                </p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Connect your ERP, e-commerce platform, or existing system for real-time synchronization.
                </p>
                <ul className="text-sm space-y-1">
          ...
          <h3 className="text-xl font-semibold mb-4">Step 1: Download the Template</h3>
          <Card className="mb-8">
            <CardContent className="p-6">
              <ol className="space-y-3">
                ...
                <li className="flex gap-3">
                  ...
                  <span>Open the template in Excel, Google Sheets, or any spreadsheet software</span>
                </li>
              </ol>
            </CardContent>
          </Card>

          <h3 className="text-xl font-semibold mb-4">Step 2: Fill in Product Data</h3>
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="border-l-4 border-primary-600 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">Unique product identifier (e.g., WIDGET-001)</p>
                </div>
                
                <div className="border-l-4 border-primary-600 pl-4">
                  <p className="font-medium">Product Name</p>
                  <p className="text-sm text-muted-foreground">Descriptive product name</p>
                </div>
                
                <div className="border-l-4 border-primary-600 pl-4">
                  <p className="font-medium">Quantity</p>
                  <p className="text-sm text-muted-foreground">Number of units in stock</p>
                </div>
                
                <div className="border-l-4 border-primary-600 pl-4">
                  <p className="font-medium">Location</p>
                  <p className="text-sm text-muted-foreground">Where item is stored (e.g., PICK-A-01-02-03)</p>
                </div>
              </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Product classification</p>
                </div>
                <div>
                  <p className="font-medium text-sm">Cost</p>
                  <p className="text-xs text-muted-foreground">Unit cost price</p>
                </div>
                <div>
                  <p className="font-medium text-sm">Weight</p>
                  <p className="text-xs text-muted-foreground">Shipping weight</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">How much to reorder</p>
                </div>
                <div>
          ...
          <Alert className="mb-8" variant="destructive">
            ...
            <AlertDescription>
              <ul className="mt-2 space-y-1 text-sm">
                ...
                <li>• Invalid location codes (must match existing locations)</li>
          ...
          <h3 className="text-xl font-semibold mb-4">Step 3: Upload and Review</h3>
          <Card className="mb-8">
            <CardContent className="p-6">
              <ol className="space-y-4">
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600 min-w-[24px]">1.</span>
                  <div>
                    <p className="font-medium">Save your completed spreadsheet as CSV</p>
                    <p className="text-sm text-muted-foreground">File, Save As, CSV (Comma delimited)</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600 min-w-[24px]">2.</span>
                  <div>
                    <p className="font-medium">Go back to Inventory, Import Inventory</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600 min-w-[24px]">3.</span>
                  <div>
                    <p className="font-medium">Click "Upload CSV" and select your file</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">System checks for errors and shows preview</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600 min-w-[24px]">5.</span>
                  <div>
                    <p className="font-medium">If validation passes, click "Confirm Import"</p>
                  </div>
                </li>
              </ol>
            </CardContent>
          ...
          <p className="text-muted-foreground mb-6">
            Connect your existing systems for automated inventory synchronization.
          </p>
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <div className="grid gap-3 sm:grid-cols-2 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">E-commerce platform sync</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">WordPress e-commerce</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Your own system</p>
                  </div>
                </div>
              </div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Need help with API integration?</strong> Our implementation team can assist with connecting your systems. <Link href="/contact" className="text-primary hover:underline">Contact us</Link> for a consultation.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>

          <h3 className="text-xl font-semibold mb-4">Basic API Integration Steps</h3>
          <Card className="mb-8">
            <CardContent className="p-6">
              <ol className="space-y-3">
                <li className="flex gap-3">
                ...
                <li className="flex gap-3">
                  ...
                  <span>Configure sync settings (frequency, field mapping)</span>
                </li>
                <li className="flex gap-3">
          ...
          <h2 className="text-2xl font-bold mb-4">After Import: Verify Your Data</h2>
          <Card className="mb-8">
            <CardContent className="p-6">
              <p className="text-muted-foreground mb-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Check total items, total value, low stock alerts</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Verify SKUs, quantities, and locations are correct</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Ensure barcodes are properly linked</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Export to verify all data imported correctly</p>
                  </div>
                </li>
              </ul>
            </CardContent>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              After initial import, schedule regular cycle counts to maintain accuracy. Start with high-value or high-velocity items and count a small portion of inventory daily.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-4 mb-8">
              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Configure scanners and tablets for your warehouse team</p>
                  </div>
            ...
            <Link href="/help/getting-started/create-first-receiving">
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    <h3 className="font-semibold">Create First Receiving Order</h3>
