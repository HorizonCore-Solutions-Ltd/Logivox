...
import { ArrowLeft, ArrowRight, CheckCircle2, Package, Lightbulb } from "lucide-react"

export const metadata: Metadata = {
  title: "Create First Receiving Order | LogiVox Help Center",
  description: "Learn how to receive incoming inventory from suppliers, inspect items, and put away stock to warehouse locations.",
}
    ...
    <div className="flex flex-col min-h-screen">
      <section className="bg-gradient-to-b from-primary-50 to-white border-b py-8">
        <div className="container-enterprise max-w-4xl">
          ...
          <h1 className="text-4xl font-bold mb-4">Create Your First Receiving Order</h1>
          <p className="text-xl text-muted-foreground">
            Process incoming inventory from suppliers with inspection, verification, and putaway workflows.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container-enterprise max-w-4xl">
          <Alert className="mb-8">
            ...
            <AlertDescription>
              A receiving order (also called an inbound order or ASN - Advanced Shipping Notice) documents expected inventory arriving from a supplier. It guides your team through unloading, inspection, and putting items away to proper locations.
            </AlertDescription>
          </Alert>
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Create Receiving Order</h3>
                    <p className="text-sm text-muted-foreground">Enter expected items from purchase order or ASN</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Scan and count items as they arrive</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">Quality Inspection (Optional)</h3>
                    <p className="text-sm text-muted-foreground">Inspect for damage or quality issues</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Move items to designated storage locations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Close receiving order and update inventory</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <h2 className="text-2xl font-bold mb-4">Step 1: Create a New Receiving Order</h2>
          <Card className="mb-8">
            <CardContent className="p-6">
              <ol className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <div>
                    <p className="font-medium">Navigate to Receiving from the main menu</p>
                  </div>
                </li>
                <li className="flex gap-3">
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              If your ERP system is integrated, you can automatically import receiving orders from purchase orders. Go to Settings, Integrations to set this up.
            </AlertDescription>
          </Alert>

          <h2 className="text-2xl font-bold mb-4">Step 2: Receive Items at the Dock</h2>
            ...
            <CardContent className="p-6">
              ...
              <ol className="space-y-3 mb-6">
                ...
                <li className="flex gap-3">
                  ...
                  <span>Select the open receiving order (or scan PO barcode)</span>
                </li>
                <li className="flex gap-3">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Received more than expected - system allows you to accept or reject extras</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Received less than expected - mark as partial receipt or cancel remaining</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Mark damaged quantity, system moves to quarantine location automatically</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <h2 className="text-2xl font-bold mb-4">Step 3: Quality Inspection (Optional)</h2>
          <p className="text-muted-foreground mb-6">
          ...
          <h2 className="text-2xl font-bold mb-4">Step 4: Putaway to Storage Locations</h2>
          <p className="text-muted-foreground mb-6">
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              <h3 className="font-semibold mb-4">System-Directed Putaway (Recommended)</h3>
              <ol className="space-y-3 mb-6">
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">1.</span>
                ...
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">3.</span>
                  <span>System suggests optimal location (based on velocity, size, rules)</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">4.</span>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              <ul className="mt-2 space-y-1 text-sm">
                <li>• <strong>Fast-movers:</strong> Place near shipping area for quick access</li>
                <li>• <strong>Slow-movers:</strong> Store in bulk area or higher shelves</li>
                <li>• <strong>Heavy items:</strong> Put on lower shelves for safety</li>
                <li>• <strong>Small items:</strong> Use bin locations to maximize space</li>
              </ul>
            </AlertDescription>
          </Alert>

          <h2 className="text-2xl font-bold mb-4">Step 5: Complete the Receiving Order</h2>
          <Card className="mb-8">
            <CardContent className="p-6">
              <p className="text-muted-foreground mb-4">
              ...
              <ol className="space-y-3">
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">1.</span>
                  <span>Review receiving summary for any outstanding items</span>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">2.</span>
                ...
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">5.</span>
                  <span>Receiving report is generated (can be printed or emailed)</span>
                </li>
              </ol>
            </CardContent>
          </Card>
          ...
          <div className="grid gap-4 sm:grid-cols-2 mb-8">
            <Card>
              <CardContent className="p-4">
                <h4 className="font-semibold mb-2">Create Receiving Orders in Advance</h4>
                <p className="text-sm text-muted-foreground">
                  Enter expected receipts as soon as you get the purchase order. Your team will be ready when shipments arrive.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Designate a receiving staging zone to separate incoming items from regular inventory until processed.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4">
                <h4 className="font-semibold mb-2">Document Damages Immediately</h4>
                <p className="text-sm text-muted-foreground">
                  Take photos and notes of any damaged items at receipt for supplier claims.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Try to receive and putaway items on the same day to keep inventory accuracy high.
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Navigate the main dashboard and monitor your operations</p>
                  </div>
              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Maintain inventory accuracy with regular counts</p>
                  </div>
                  <ArrowRight className="h-5 w-5 text-primary-600" />
                </CardContent>
              </Card>
