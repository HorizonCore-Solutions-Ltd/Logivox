...
export const metadata: Metadata = {
  ...
  description:
    "Learn how to invite team members and configure role-based access control in LogiVox WMS.",
};
  ...
  const roles = [
    {
      name: "Administrator",
      description:
        "Full system access including configuration, user management, and all features",
      permissions: [
        "All permissions",
        "User management",
    ...
    },
    {
      ...
      description:
        "Manage daily operations, view reports, assign tasks, but cannot modify system settings",
      permissions: [
        "View all data",
        "Manage inventory",
        "Create orders",
    ...
    },
    {
      name: "Supervisor",
      description:
        "Oversee team activities, approve tasks, and access operational reports",
      permissions: [
        "View team data",
        "Approve tasks",
        "Basic reporting",
    ...
    },
    {
      ...
      description:
        "Perform daily tasks like receiving, picking, packing, and shipping",
      permissions: [
        "Receiving",
        "Picking",
        "Packing",
    ...
    },
    {
      ...
      description:
        "Focused on inventory management, cycle counting, and stock adjustments",
      permissions: [
        "View inventory",
        "Cycle counting",
        "Stock adjustments",
    ...
    },
    {
      name: "Read-Only",
      description:
        "View-only access for auditors, clients, or external stakeholders",
      permissions: [
        "View inventory",
        "View orders",
        "View reports",
      ...
      <section className="bg-gradient-to-b from-primary-50 to-white border-b py-8">
        <div className="container-enterprise max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground">
            Invite team members and configure role-based access control to keep
            your data secure.
          </p>
        </div>
      </section>
        ...
        <div className="container-enterprise max-w-4xl">
          <div className="prose prose-lg max-w-none">
            <Alert className="mb-8">
              ...
              <AlertDescription>
                LogiVox uses role-based access control (RBAC) to ensure users
                only access what they need. Always follow the principle of least
                privilege.
              </AlertDescription>
            </Alert>
              ...
              <CardContent className="p-6">
                <ol className="space-y-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Select <strong>Users & Teams</strong>
                    </span>
                  </li>
                  <li className="flex gap-3">
                    <span className="font-semibold text-primary-600 min-w-[24px]">
            ...
            <div className="space-y-6 mb-8">
              <div className="border-l-4 border-primary-600 pl-4">
                ...
                <p className="text-muted-foreground">
                  Enter the user's work email. They'll receive an invitation
              ...
              <div className="border-l-4 border-primary-600 pl-4">
                ...
                <p className="text-muted-foreground">
                  First and last name. This will appear throughout the system
                  for audit trails.
                </p>
              </div>
              ...
              <div className="border-l-4 border-primary-600 pl-4">
                ...
                <p className="text-muted-foreground">
                  Select the appropriate role based on their job function (see
                  roles below).
                </p>
              </div>
              ...
              <div className="border-l-4 border-primary-600 pl-4">
                ...
                <p className="text-muted-foreground">
                  If you have multiple warehouses, specify which ones this user
                  can access.
                </p>
              </div>
            </div>
            ...
            <Alert className="mb-8">
              ...
              <AlertDescription>
                Need a custom role with specific permissions? Enterprise plans
                can create custom roles tailored to your organization.{" "}
                <Link
                  href="/contact?subject=custom-roles"
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Double-check email, name, and role assignment
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
            ...
            <div className="grid gap-4 mb-8">
              <Card>
                <CardContent className="p-4 flex items-center gap-3">
                  ...
                  <div>
                    <strong>Change Roles</strong> - Update a user's permissions
                    at any time
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 flex items-center gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 flex-shrink-0" />
                  <div>
                    <strong>Deactivate Users</strong> - Temporarily disable
              ...
              <Card>
                <CardContent className="p-4 flex items-center gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 flex-shrink-0" />
                  <div>
                    <strong>View Activity Logs</strong> - Track what users are
                    doing in the system
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4 flex items-center gap-3">
                  <CheckCircle2 className="h-5 w-5 text-primary-600 flex-shrink-0" />
                  <div>
                    <strong>Resend Invitations</strong> - If the original email
                    was missed
                  </div>
                </CardContent>
              </Card>
            ...
            <Alert className="mb-8" variant="default">
              ...
              <AlertDescription>
                Users are billed monthly based on your plan. Active users count
                toward your subscription limit. Deactivated users don't count.
              </AlertDescription>
            </Alert>
              ...
              <CardContent className="p-6">
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>Use work emails only</strong> - Don't use personal
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Start with less access</strong> - You can always
                      grant more permissions later
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Limit administrators</strong> - Only give admin
                      access to those who truly need it
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Review users quarterly</strong> - Remove access
                      for employees who've left or changed roles
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Enable 2FA</strong> - Require two-factor
      ...
      <section className="border-t py-8">
        <div className="container-enterprise max-w-4xl text-center">
          ...
          <p className="text-sm text-muted-foreground mt-6">
            Need more help?{" "}
            <Link
              href="/contact?subject=help-user-management"
              className="text-primary hover:underline"
            >
              Contact support
            </Link>
