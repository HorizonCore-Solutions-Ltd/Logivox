...
export const metadata: Metadata = {
  ...
  description:
    "Integrate FedEx, UPS, USPS, and other carriers for automated rate shopping, label printing, and tracking.",
};
      ...
      <section className="bg-gradient-to-b from-primary-50 to-white border-b py-8">
        <div className="container-enterprise max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground">
            Integrate FedEx, UPS, USPS, and other carriers for automated
            shipping, rate shopping, and tracking.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container-enterprise max-w-4xl">
          <Alert className="mb-8">
            ...
            <AlertDescription>
              Direct carrier integration enables real-time rate comparison,
              automatic label printing, package tracking, and simplified
              billing. Save time and money on every shipment.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-4 md:grid-cols-2 mb-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Fast domestic and international shipping with extensive
                  tracking.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Reliable service with advanced logistics capabilities.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Cost-effective option for lightweight packages and residential
                  delivery.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Best for international shipments with global reach.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Domestic and international service for Canadian operations.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      OnTrac, LaserShip, etc.
                    </p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">
                  Cost-effective regional alternatives with zone-specific
                  service.
                </p>
              </CardContent>
            </Card>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sign up directly with each carrier you want to use
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Request developer/API access from carrier support
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Your warehouse "ship from" address on file with carriers
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Thermal printer for 4x6 shipping labels
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              If you have negotiated shipping rates with carriers, make sure to
              use those API credentials. This ensures you get your discounted
              rates when LogiVox requests quotes.
            </AlertDescription>
          </Alert>

          <h2 className="text-2xl font-bold mb-4">
            Step-by-Step: FedEx Integration
          </h2>
          <Card className="mb-8">
            <CardContent className="p-6">
              ...
              <ol className="space-y-3 mb-6">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Note down: API Key, Secret Key, Account Number, Meter Number
                  </span>
                </li>
              </ol>

              <h3 className="font-semibold mb-4">
                Step 2: Configure in LogiVox
              </h3>
              ...
              <ol className="space-y-3 mb-6">
                <li className="flex gap-3">
                  ...
                  <span>
                    Go to{" "}
                    <Link
                      href="https://www.ups.com/upsdeveloperkit"
                      className="text-primary hover:underline"
                      target="_blank"
                    >
                      UPS Developer Kit
            ...
            <CardContent className="p-6">
              ...
              <ol className="space-y-3 mb-6">
                ...
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">4.</span>
                  <span>
                    Request production access (test account has limits)
                  </span>
                </li>
              </ol>
          ...
          <p className="text-muted-foreground mb-6">
            Rate shopping automatically compares prices across carriers to find
            the best rate for each shipment.
          </p>
            ...
            <CardContent className="p-6">
              ...
              <div className="ml-6 space-y-3 border-l-2 border-primary-200 pl-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Always select lowest cost option
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Consider both cost and delivery time
                  </p>
                </div>
                <div>
                  <p className="font-medium text-sm">Custom Rules</p>
                  <p className="text-xs text-muted-foreground">
                    Set carrier preferences by weight, destination, or product
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              ...
              <ol className="space-y-3 mb-6">
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">1.</span>
                  <span>
                    Connect thermal label printer to computer (USB or network)
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="font-semibold text-primary-600">2.</span>
              ...
              <Alert>
                <Lightbulb className="h-4 w-4" />
                <AlertDescription>
                  <strong>No label printer?</strong> You can print to standard
                  paper (8.5x11) or save labels as PDF and print later. Thermal
                  printers are recommended for high volume.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
          ...
          <div className="grid gap-4 sm:grid-cols-2 mb-8">
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Integrate at least 2-3 carriers to ensure you always have
                  competitive rates and backup options.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Track delivery times and damage rates. Switch carriers if
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Ensure product dimensions in system are accurate. Incorrect
                  dimensions lead to billing adjustments.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Set up daily pickup schedules with carriers instead of calling
                  each time.
                </p>
              </CardContent>
            </Card>
              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Adapt LogiVox to your specific warehouse processes
                    </p>
                  </div>
