...
export const metadata: Metadata = {
  ...
  description:
    "Navigate the main dashboard and understand key performance metrics, widgets, and actionable insights.",
};
      ...
      <section className="bg-gradient-to-b from-primary-50 to-white border-b py-8">
        <div className="container-enterprise max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground">
            Navigate the main dashboard, understand key metrics, and customize
            your view.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container-enterprise max-w-4xl">
          <Alert className="mb-8">
            ...
            <AlertDescription>
              The dashboard provides real-time visibility into warehouse
              operations, inventory levels, order status, and performance
              metrics. It's your starting point each day.
            </AlertDescription>
          </Alert>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-primary-600 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Access main modules (Receiving, Picking, Shipping,
                    Inventory, etc.) and notifications
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Quick view cards showing critical numbers (orders, inventory
                    value, alerts)
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-200 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tasks requiring attention (low stock alerts, pending orders,
                    quality holds)
                  </p>
                </div>
              </div>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              Metrics use color coding: Green (good), Orange (needs attention),
              Red (urgent action required). Click any metric card to view
              detailed breakdown.
            </AlertDescription>
          </Alert>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Line chart showing daily/weekly order counts
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Percentage of orders picked correctly first time
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="p-4 border-l-4 border-orange-500 bg-orange-50">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    Items below reorder point. Consider creating purchase
                    orders.
                  </p>
            ...
            <CardContent className="p-6">
              ...
              <ol className="space-y-3">
                ...
                <li className="flex gap-3">
                  ...
                  <span>
                    Click "Add Widget" to include additional metrics or charts
                  </span>
                </li>
                <li className="flex gap-3">
          ...
          <div className="grid gap-4 sm:grid-cols-2 mb-8">
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Configure dashboard to load automatically when you login. Go
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Dashboard auto-refreshes every 60 seconds. Click refresh icon
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Mobile app has simplified dashboard optimized for smaller
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Click any chart or metric to export detailed data as PDF or
                  Excel.
                </p>
              </CardContent>
            </Card>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              Different user roles see different metrics. Warehouse managers see
              operational metrics, while executives see financial and strategic
              KPIs. Customize based on your role.
            </AlertDescription>
          </Alert>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Click any metric or chart to see detailed breakdown
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use date picker to view different time periods
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Enable comparison view to see week-over-week or
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use quick action buttons to jump to common tasks (Create
                      Order, Receive Shipment, etc.)
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Hardware setup and testing procedures
                    </p>
                  </div>
