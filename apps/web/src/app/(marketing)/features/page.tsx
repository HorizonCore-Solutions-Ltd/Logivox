...
export default function FeaturesPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      tier: "enterprise",
      icon: Gauge,
      name: "Integrated Yard Management",
      benefit: "Full gate-to-dock visibility and automated shunter dispatch",
      description:
        "Live yard map showing all dock doors, parking spots, and staging areas. Automated gate check-in with license plate capture, security screening, and appointment linking. PULL_TO_DOCK and SPOT_TRAILER tasks dispatched to yard drivers in one click. Detect detention risk before fees accumulate.",
      impact: "Eliminate detention fees, reduce yard wait times 65%, increase dock throughput 40%",
      usedBy: ["Enterprise"],
    },
    {
      category: "Next-Gen Intelligence",
      tier: "enterprise",
      icon: Sparkles,
      name: "Robotics & Automation Command Center",
      benefit: "Orchestrate AMRs, AGVs, cobots and sortation systems from one UI",
      description:
        "AI-powered fleet dispatch matches queued tasks to the best available robot by type, battery level, and proximity. Real-time battery, utilization, and task count per device. Cross-belt sorters, AS/RS cranes, and conveyors monitored with 8-hour throughput charts and per-device success rates. Manual override dispatch for any idle robot with full task history.",
      impact: "4x throughput increase without added headcount, 95%+ sortation success rate",
      usedBy: ["Enterprise"],
    },
    {
      category: "Next-Gen Intelligence",
      tier: "enterprise",
      icon: Zap,
      name: "Enterprise IoT Sensor Network",
      benefit: "100% cold-chain compliance through real-time sensor telemetry",
      description:
        "Monitor temperature, humidity, RFID reads, and weight/scale data live across your entire facility. Threshold breach alerts fire in real-time. RFID portal dashboards show per-reader scan rates and network health. Weight station pass/fail rates tracked per scale. Environmental compliance reports generated automatically for audits.",
      impact: "Zero inventory spoilage, 100% cold-chain audit pass rate, 20% shrinkage reduction",
      usedBy: ["Enterprise"],
    },
  ];
