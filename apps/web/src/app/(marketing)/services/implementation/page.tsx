...
import { CheckCircle2, ArrowRight, Rocket, Users, FileCheck, Settings, TrendingUp, Shield } from "lucide-react"
import Link from "next/link"

export const metadata: Metadata = {
  title: "Implementation Services | LogiVox WMS",
  description: "Expert WMS implementation services. From planning to go-live, our certified team ensures successful deployment with minimal disruption.",
}
        ...
        <div className="container-enterprise">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Deploy your warehouse management system with confidence. Our certified implementation team guides you from planning through go-live and beyond.
            </p>
      ...
      <section className="py-20">
        <div className="container-enterprise">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Our Proven Implementation Methodology</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              A structured 5-phase approach that minimizes risk and ensures on-time, on-budget delivery
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Requirements gathering, process mapping, and project planning",
                duration: "2-3 weeks",
                icon: FileCheck,
              },
              {
          ...
          <div className="mt-12 text-center">
            <p className="text-lg font-semibold mb-2">Typical Timeline: 8-12 weeks from kickoff to go-live</p>
            <p className="text-muted-foreground">Timeline varies based on complexity and customization requirements</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-enterprise">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Comprehensive implementation services with everything you need for success
            </p>
          </div>
        ...
        <div className="container-enterprise">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={pkg.name} className={pkg.featured ? "border-2 border-primary-600 shadow-lg" : ""}>
                {pkg.featured && (
                ...
                <CardContent className="space-y-6">
                  <div>
                    <p className="text-sm font-semibold mb-2">Timeline: {pkg.timeline}</p>
                  ...
                  <Button className="w-full" variant={pkg.featured ? "default" : "outline"} asChild>
                    <Link href={`/contact?service=implementation&package=${pkg.name.toLowerCase()}`}>
                      Get Started
                    </Link>
                  </Button>
                </CardContent>
          ...
          <Card className="bg-gradient-to-br from-primary-600 to-primary-700 text-white border-0">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90">
                Schedule a consultation with our implementation experts to discuss your requirements and create a custom deployment plan.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
