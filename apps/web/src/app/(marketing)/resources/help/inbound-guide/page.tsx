      ...
      <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-10">
        ...
        <main className="space-y-8">
          ...
          <section id="getting-started" className="scroll-mt-24 space-y-4">
            ...
            <p>
              The <strong>Inbound & Inventory</strong> module is designed for
              warehouse staff. It is mobile-optimized but can also be used on
            ...
            <Alert>
              ...
              <AlertDescription>
                Ensure you have the "Warehouse Operator" or "Admin" role to
                access receiving functions.
              </AlertDescription>
            </Alert>
          </section>
          ...
          <section id="receiving-workflow" className="scroll-mt-24 space-y-4">
            ...
            <p>
              Receiving typically starts with a Purchase Order (PO) or an
              Advance Shipping Notice (ASN).
            </p>
            <ol className="list-decimal pl-6 space-y-2 marker:font-bold">
              <li>
                Navigate to <strong>Inventory &gt; Inbound</strong>.
              </li>
              <li>
                Select the incoming shipment from the list or scan the PO
                barcode.
              </li>
              <li>Scan each item's barcode as you unload.</li>
              <li>
                Verify the quantity. Over-receiving will trigger a manager
                approval workflow.
              </li>
            ...
            <Card className="mt-4">
              ...
              <CardContent className="pt-4 text-sm">
                If you trust the vendor's pallet configuration, you can receive
                entire License Plates (LPNs) at once instead of scanning
                individual cartons.
              </CardContent>
            </Card>
          </section>
          ...
          <section id="cross-docking" className="scroll-mt-24 space-y-4">
            ...
            <p>
              When you receive an item that is currently backordered, the system
              will trigger a <strong>Cross-Dock Alert</strong>.
            </p>
            <div className="flex gap-4 items-start bg-amber-50 dark:bg-amber-950/30 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 dark:text-amber-500 mt-1">
                  Do not put this item away! The scanner will direct you to a
                  staging lane (e.g., STAGE-01). Move the goods directly to
                  shipping.
                </p>
              </div>
            </div>
          ...
          <section id="smart-slotting" className="scroll-mt-24 space-y-4">
            ...
            <p>
              Once received, items must be put away. The "Inbound Brain"
              suggests the optimal bin location.
            </p>
            <ul className="grid gap-2">
              <li className="flex gap-2 bg-muted/40 p-2 rounded">
                <Check className="h-4 w-4 text-green-500 mt-1" />
                <span>
                  <strong>Velocity:</strong> Fast movers go to golden zones
                  (waist-height, near shipping).
                </span>
              </li>
              <li className="flex gap-2 bg-muted/40 p-2 rounded">
                <Check className="h-4 w-4 text-green-500 mt-1" />
                <span>
                  <strong>Dimensions:</strong> Heavy items go to bottom racks.
                </span>
              </li>
            </ul>
            <p className="mt-4">
              To override a suggestion, scan a different valid bin location. The
              system will learn from your override over time.
            </p>
          </section>
            ...
            <div className="grid gap-4">
              <div className="border rounded-lg p-4">
                <h4 className="font-semibold mb-2">
                  Scanner not picking up barcode?
                </h4>
                <p className="text-sm text-muted-foreground">
                  Ensure the cursor is focused on the input field. Check if the
                  barcode is damaged. You can manually type the SKU if
                  necessary.
                </p>
              </div>
              <div className="border rounded-lg p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  The system thinks the bin is at capacity. If visual inspection
                  shows space, you can perform a "Cycle Count" to correct the
                  system inventory.
                </p>
              </div>
            </div>
