...
export const metadata: Metadata = {
  ...
  description:
    "Complete guide to compatible hardware, software requirements, and technical specifications for LogiVox WMS.",
};
        ...
        <div className="container-enterprise">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">
              LogiVox works with a wide range of devices and platforms. Find out
              what you need to run your warehouse operations smoothly.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <Alert className="mb-12">
              ...
              <AlertDescription className="text-base">
                LogiVox is designed to work with devices you already own.
                Whether you're using smartphones, dedicated scanners, or
                industrial tablets, we've got you covered.
              </AlertDescription>
            </Alert>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">
                Use smartphones or industrial mobile computers for warehouse
                operations
              </p>
            </div>
            ...
            <Card className="bg-gradient-to-br from-primary-50 to-white border-primary-200">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6">
                  For demanding warehouse environments, consider ruggedized
                  mobile computers with integrated barcode scanners:
                </p>
                ...
                <Alert className="mt-6">
                  <AlertDescription>
                    <strong>Android Enterprise Recommended:</strong> All
                    industrial devices run Android Enterprise for enhanced
            ...
            <div className="grid gap-8 md:grid-cols-2 mb-12">
                ...
                <CardContent className="p-8">
                  ...
                  <Alert>
                    <AlertDescription className="text-sm">
                      <strong>Recommended:</strong> Direct thermal printers (no
                      ink/ribbon needed) for shipping labels. Thermal transfer
                      for durable warehouse labels.
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-8">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm">
                        ...
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                          <span>
                            Laser printers recommended for high volume
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                  ...
                  <Alert>
                    <AlertDescription className="text-sm">
                      <strong>Print to PDF:</strong> No printer? Save documents
                      as PDF and print later, or email pick lists directly to
                      warehouse staff.
                    </AlertDescription>
                  </Alert>
                </CardContent>
              ...
              <CardContent className="p-6">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Connect printer directly to computer via USB cable
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Share printer across multiple workstations on your network
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-sm mb-2">Cloud Print</h4>
                    <p className="text-sm text-muted-foreground">
                      Print from mobile devices using cloud print services
                    </p>
                  </div>
                </div>
              </CardContent>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                          <span>
                            <strong>OS:</strong> Windows 10/11, macOS 10.15+, or
                            Linux (Ubuntu 20.04+)
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
              ...
              <Card>
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                      ...
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Version 90 or later (best performance)
                            </p>
                          </div>
                        </li>
                        <li className="flex items-start gap-2">
                        ...
                        <li className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              Version 14 or later (macOS only)
                            </p>
                          </div>
                        </li>
                      </ul>
                    ...
                    <Alert>
                      <AlertDescription className="text-sm">
                        <strong>Note:</strong> JavaScript must be enabled.
                        Cookies required for authentication. Pop-up blocker may
                        need to be disabled for printing.
                      </AlertDescription>
                    </Alert>
                  </div>
                </CardContent>
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      LogiVox is a cloud-based system requiring stable internet
                      connection
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Minimum:</strong> 5 Mbps download / 2 Mbps
                          upload
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Recommended:</strong> 25 Mbps download / 10
                          Mbps upload
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Latency:</strong> Under 100ms (lower is
                          better)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Bandwidth:</strong> Add 1 Mbps per concurrent
                          user
                        </span>
                      </li>
                    </ul>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Standard:</strong> 802.11n (WiFi 4) minimum,
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Coverage:</strong> Full warehouse coverage
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Security:</strong> WPA2 or WPA3 encryption
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                        <span>
                          <strong>Access Points:</strong> Consider multiple APs
            ...
            <Card className="border-primary-200">
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-sm">
                  <p className="text-muted-foreground">
                    If your network has firewall restrictions, ensure these
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                      <span>
                        <strong>HTTPS (443):</strong> For web application access
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                      <span>
                        <strong>WebSocket (443):</strong> For real-time updates
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="h-4 w-4 text-green-600 flex-shrink-0 mt-0.5" />
                      <span>
                        <strong>Domains:</strong> *.logivox.com, *.logivox.app
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="container-enterprise">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-primary-100">
              Our team can recommend the best hardware setup for your warehouse
              size and budget.
            </p>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold mb-2">
                    Do I need to buy special hardware to use LogiVox?
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    No! LogiVox works with devices you likely already have. Any
                    modern smartphone can scan barcodes using the camera.
                    Standard computers with web browsers can access the full
                    system. While industrial scanners and thermal printers
                    improve efficiency, they're optional.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold mb-2">
                    Can I use my existing barcode scanners?
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Yes! Most USB and Bluetooth barcode scanners work with
                    LogiVox. As long as your scanner operates in keyboard wedge
                    mode (types like a keyboard), it will work. Check our
                    compatibility list or contact support to verify your
                    specific model.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold mb-2">
                    Does LogiVox work offline?
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    LogiVox requires internet connection for full functionality.
                    However, our mobile apps have limited offline mode that
                    caches recent data and syncs when connection is restored.
                    For critical operations, we recommend backup internet
                    (cellular hotspot).
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold mb-2">
                    What if my scanner model isn't listed?
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    The lists above show popular models, but LogiVox works with
                    most scanners that support standard barcode symbologies.
                    Contact our support team with your scanner model and we'll
                    verify compatibility or help with configuration.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="font-semibold mb-2">
                    Do you provide hardware as part of the service?
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    LogiVox is software-only. However, we partner with hardware
                    vendors to offer competitive pricing on recommended devices.
                    We can also connect you with local suppliers. Contact us for
