...
export default function BenefitsPage() {
  const mainBenefits = [
    {
      ...
      metric: "30 Days",
      subtitle: "See measurable returns quickly from production use",
      bullets: [
        "Average ROI visible within 30 days of live use",
        "93% of customers achieve cost payback within 90 days",
        "Typical ROI visible within 90 days for Professional tier customers",
        "Implementation completed in 30 days for standard deployments",
      ],
  ...
  const byRole = [
    ...
    },
    {
      ...
      benefits: [
        "30-day ROI visibility in real production use",
