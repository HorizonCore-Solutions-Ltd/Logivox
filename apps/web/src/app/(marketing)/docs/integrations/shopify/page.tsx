...
export const metadata: Metadata = {
  ...
  description: "Connect your Shopify store with LogiVox WMS. Sync orders, inventory, and fulfillment automatically.",
}
...
export default function ShopifyIntegrationPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-gradient-to-b from-slate-900 to-slate-800 text-white border-b py-16">
        <div className="container-enterprise">
          ...
          <p className="text-xl text-slate-300 max-w-3xl">
            Seamlessly connect your Shopify store with LogiVox to automate order fulfillment and keep inventory synchronized in real-time.
          </p>
          <div className="flex items-center gap-3 mt-6">
            <Badge className="bg-green-500 text-white">Official Integration</Badge>
            <Badge variant="outline" className="bg-white/10 text-white border-white/20">Two-Way Sync</Badge>
            <Badge variant="outline" className="bg-white/10 text-white border-white/20">Real-time</Badge>
          </div>
        </div>
      </section>
        ...
        <div className="container-enterprise max-w-4xl">
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Add LogiVox to your Shopify store in minutes</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <ol className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Search for "LogiVox WMS" or use this direct link:</p>
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Review the permissions requested by LogiVox</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">LogiVox will request access to orders, products, and inventory</p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">You'll be redirected to configure your integration settings</p>
                  </div>
                </li>
              </ol>
              ...
              <Alert>
                ...
                <AlertDescription>
                  Test the Shopify integration free for 14 days. No credit card required.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Connect Shopify locations to LogiVox warehouses</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Map each Shopify location to a corresponding LogiVox warehouse. This ensures inventory counts stay synchronized.
                </p>
                <div className="border rounded-lg p-4 bg-muted/50">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
                      <div>
                        <div className="font-medium">Main Warehouse (Shopify)</div>
                        <div className="text-sm text-muted-foreground">New York, NY</div>
                      </div>
                      <ArrowRight className="h-5 w-5 text-muted-foreground" />
                      <div>
                        <div className="font-medium">NYC Distribution Center</div>
                        <div className="text-sm text-muted-foreground">LogiVox WH-001</div>
                      </div>
                    </div>
                    <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
                      <div>
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">LogiVox WH-002</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure how orders flow from Shopify to LogiVox</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Import orders immediately when placed in Shopify</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Only import paid orders (recommended)</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Set LogiVox as the fulfillment service</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Let Shopify send shipping notifications</div>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Control how inventory levels synchronize</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Every 5 minutes (configurable)</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">LogiVox → Shopify (one-way recommended)</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Reserve 5 units to prevent overselling</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 border rounded-lg">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Continue selling when out of stock: No</div>
                    </div>
                  </div>
                </div>
              </CardContent>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container-enterprise max-w-4xl">
          <h2 className="text-3xl font-bold mb-8">Advanced: Webhook Configuration</h2>
          
          <Card>
            <CardHeader>
              <CardTitle>Real-time Event Notifications</CardTitle>
              <CardDescription>For developers who want more control</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <p className="text-muted-foreground">
                LogiVox automatically configures webhooks during installation. If you need to set them up manually:
              </p>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-3 border rounded-lg">
                    ...
                    <span className="text-sm text-muted-foreground">New order placed</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 border rounded-lg">
                    <Code className="h-4 w-4 text-primary-600" />
                    <code className="text-sm">orders/updated</code>
                    <span className="text-sm text-muted-foreground">Order details changed</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 border rounded-lg">
                    <Code className="h-4 w-4 text-primary-600" />
                  ...
                  <div className="flex items-center gap-3 p-3 border rounded-lg">
                    ...
                    <span className="text-sm text-muted-foreground">New product added</span>
                  </div>
                  <div className="flex items-center gap-3 p-3 border rounded-lg">
                    <Code className="h-4 w-4 text-primary-600" />
                    <code className="text-sm">products/update</code>
                    <span className="text-sm text-muted-foreground">Product details updated</span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="container-enterprise max-w-4xl text-center">
          ...
          <p className="text-lg text-slate-300 mb-8">
            Start syncing orders and inventory in minutes with our Shopify integration.
          </p>
