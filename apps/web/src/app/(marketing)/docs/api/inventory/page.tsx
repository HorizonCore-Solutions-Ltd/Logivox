...
export const metadata: Metadata = {
  ...
  description: "Complete API reference for inventory management endpoints. Query stock levels, update quantities, and manage products.",
}
      ...
      <section className="bg-gradient-to-b from-slate-900 to-slate-800 text-white border-b py-16">
        <div className="container-enterprise">
          ...
          <p className="text-xl text-slate-300 max-w-3xl">
            Manage your warehouse inventory programmatically. Query stock levels, update quantities, and track product movements.
          </p>
        </div>
      </section>
        ...
        <div className="container-enterprise max-w-4xl">
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Retrieve a paginated list of all inventory items</CardDescription>
            </CardHeader>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex gap-4 p-3 border rounded-lg">
                    <code className="font-mono text-primary-600">warehouse_id</code>
                    <span className="text-muted-foreground">Filter by warehouse</span>
                  </div>
                  <div className="flex gap-4 p-3 border rounded-lg">
                  ...
                  <div className="flex gap-4 p-3 border rounded-lg">
                    ...
                    <span className="text-muted-foreground">Filter by status (active, low_stock, out_of_stock)</span>
                  </div>
                  <div className="flex gap-4 p-3 border rounded-lg">
                    <code className="font-mono text-primary-600">limit</code>
                    <span className="text-muted-foreground">Results per page (default: 50, max: 100)</span>
                  </div>
                  <div className="flex gap-4 p-3 border rounded-lg">
        ...
        <div className="container-enterprise max-w-4xl">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Retrieve detailed information about a specific inventory item</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="p-3 border rounded-lg">
                  ...
                  <span className="text-muted-foreground ml-4">Inventory item ID</span>
                </div>
              </div>
        ...
        <div className="container-enterprise max-w-4xl">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Increase or decrease inventory quantities with reason tracking</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  All adjustments are logged with timestamps, user information, and reasons for full traceability.
                </AlertDescription>
              </Alert>
            ...
            <Link href="/docs/api/orders" className="group">
              <Card className="h-full hover:shadow-lg hover:border-primary transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="group-hover:text-primary transition-colors">Orders API</CardTitle>
                  <CardDescription>Manage orders and fulfillment</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Link href="/docs/api/warehouses" className="group">
              <Card className="h-full hover:shadow-lg hover:border-primary transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="group-hover:text-primary transition-colors">Warehouses API</CardTitle>
                  <CardDescription>Configure warehouse locations</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center text-primary">
                    <span className="text-sm font-medium">View documentation</span>
            ...
            <Link href="/docs/api/reports" className="group">
              <Card className="h-full hover:shadow-lg hover:border-primary transition-all">
                <CardHeader>
                  ...
                  <CardTitle className="group-hover:text-primary transition-colors">Reports API</CardTitle>
                  <CardDescription>Generate analytics and reports</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center text-primary">
                    <span className="text-sm font-medium">View documentation</span>
      ...
      <section className="py-16 bg-slate-900 text-white">
        <div className="container-enterprise max-w-4xl text-center">
          ...
          <p className="text-lg text-slate-300 mb-8">
            Check out our comprehensive API getting started guide or contact our developer support team.
          </p>
