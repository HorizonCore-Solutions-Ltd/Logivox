...
export const metadata: Metadata = {
  ...
  description: 'Complete API reference for LogiVox WMS. RESTful endpoints, authentication, webhooks, and integration guides for developers.',
  keywords: ['API documentation', 'REST API', 'WMS API', 'API integration', 'developer documentation'],
}

export default function APIDocumentationPage() {
  const endpoints = [
    { category: 'Inventory', count: 25, description: 'Stock levels, locations, movements' },
    { category: 'Orders', count: 18, description: 'Order creation, fulfillment, status' },
    { category: 'Receiving', count: 12, description: 'GRN, putaway, ASN processing' },
    { category: 'Shipping', count: 15, description: 'Carriers, labels, tracking' },
    { category: 'Wave Picking', count: 10, description: 'Wave creation, allocation, execution' },
    { category: 'Returns', count: 14, description: 'RMA, refunds, disposition' },
    { category: 'Reporting', count: 8, description: 'KPIs, analytics, exports' },
    { category: 'Yard Management', count: 9, description: 'Appointments, gates, docks' },
  ]
  ...
  const features = [
    {
      icon: Code,
      title: 'RESTful API',
      description: 'Standard HTTP methods (GET, POST, PUT, DELETE) with JSON payloads for maximum compatibility.',
    },
    {
      icon: Key,
      title: 'API Key Authentication',
      description: 'Secure API keys with role-based permissions. Support for multiple keys per tenant.',
    },
    {
      icon: Webhook,
      title: 'Webhooks',
      description: 'Real-time event notifications for inventory changes, order updates, and shipments.',
    },
    {
      icon: Shield,
      title: 'Rate Limiting',
      description: '1,000 requests/minute per key. Burst handling and automatic retry with exponential backoff.',
    },
    {
      icon: Database,
      title: 'Batch Operations',
      description: 'Process multiple records in a single request. Bulk inventory updates, order imports.',
    },
    {
      icon: FileCode,
      title: 'OpenAPI Spec',
      description: 'Complete OpenAPI 3.0 specification. Generate client libraries in any language.',
    },
  ]

  const quickstart = [
    { step: 1, title: 'Get API Key', description: 'Generate from Settings > Integrations' },
    { step: 2, title: 'Make Request', description: 'Include key in Authorization header' },
    { step: 3, title: 'Handle Response', description: 'Parse JSON response and handle errors' },
  ]
        ...
        <div className="container-enterprise py-20 lg:py-28">
          <div className="max-w-4xl">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-6">
              ...
              <span className="text-primary-400 block mt-2">With Our REST API</span>
            </h1>
            <p className="text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
              Complete API reference with 111 endpoints covering every aspect of warehouse management. Authentication, webhooks, batch operations, and real-time data access.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="text-lg bg-white text-slate-900 hover:bg-slate-100" asChild>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="container-enterprise">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">API Endpoints by Category</h2>
      ...
      <section className="py-20 lg:py-28 bg-slate-50">
        <div className="container-enterprise">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade API with security, performance, and developer experience in mind
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto">
              <div className="flex items-center justify-between mb-4">
                <span className="text-white font-semibold">Example Request</span>
  ...
  -H "Content-Type: application/json"`}</code>
            ...
            <div className="bg-slate-900 rounded-xl p-6 overflow-x-auto mt-4">
              <div className="flex items-center justify-between mb-4">
                <span className="text-white font-semibold">Example Response</span>
            ...
            <div className="flex items-start gap-6 mb-12">
              ...
              <div className="flex-1">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
                    <span>Role-based permissions (read-only, read-write, admin)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="h-5 w-5 text-primary-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="container-enterprise">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-primary-100 max-w-2xl mx-auto">
              Get API access and start integrating with LogiVox WMS today. Full documentation, code examples, and developer support included.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-primary-600 hover:bg-primary-50 text-lg" asChild>
                <Link href="/contact?subject=API Access">
                  Request API Access
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
