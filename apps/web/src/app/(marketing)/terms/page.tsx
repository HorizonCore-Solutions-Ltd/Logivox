...
export const metadata: Metadata = {
  ...
  description:
    "LogiVox Terms of Service - Legal terms and conditions for using our enterprise inventory management platform.",
};
      ...
      <section className="border-b bg-muted/50 py-16">
        <div className="container-enterprise">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl">
            Legal terms and conditions governing your use of the LogiVox
            platform.
          </p>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-800 dark:text-amber-200">
                    By accessing or using LogiVox, you agree to be bound by
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                agreement between you (either an individual or entity, "you" or
                "Customer") and LogiVox Inc. ("LogiVox," "we," "us," or "our")
                governing your access to and use of the LogiVox platform,
            ...
            <div className="mb-12">
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li>
                  <strong>"Service"</strong> means the LogiVox enterprise
                  inventory management and stock booking platform
                </li>
                <li>
                  <strong>"Account"</strong> means your unique account created
                  to access the Service
                </li>
                <li>
                  <strong>"Organization"</strong> means the business entity or
                  group you represent
                </li>
                <li>
                  <strong>"User"</strong> means any individual authorized by an
                  Organization to use the Service
                </li>
                <li>
                  <strong>"Content"</strong> means data, information, and
                  materials submitted or created through the Service
                </li>
                <li>
                  <strong>"Subscription"</strong> means your paid access to the
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                enter into contracts to use the Service. By using LogiVox, you
              ...
              <p className="text-muted-foreground">
                LogiVox is designed for business and commercial use. You may not
                use the Service for personal, family, or household purposes.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                Subject to these Terms and payment of applicable fees, LogiVox
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                LogiVox offers various subscription plans with different
              ...
              <p className="text-muted-foreground">
                ...
                period unless canceled at least 24 hours before renewal. You can
                cancel auto-renewal in your Account settings.
              </p>
              ...
              <p className="text-muted-foreground">
                We may offer free trials of paid features. At the end of the
                trial period, you will be automatically charged for a
                subscription unless you cancel before the trial ends.
              </p>

              <h3 className="text-xl font-semibold mt-6 mb-3">5.5 Taxes</h3>
              <p className="text-muted-foreground">
                All fees are exclusive of applicable taxes (sales tax, VAT,
                GST). You are responsible for paying all applicable taxes.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                display through the Service. By submitting Content, you grant
                LogiVox a worldwide, non-exclusive, royalty-free license to use,
                store, process, and display your Content solely to provide and
                improve the Service.
              </p>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  • You own or have the necessary rights to use and share the
                  Content
                </li>
                <li>
                ...
                <li>
                  • Your Content does not contain malware, viruses, or harmful
                  code
                </li>
              ...
              <p className="text-muted-foreground">
                ...
                maintaining your own backup copies of your Content. LogiVox is
                not liable for any loss or corruption of Content.
              </p>
              ...
              <p className="text-muted-foreground">
                ...
                data. However, no system is 100% secure. See our{" "}
            ...
            <div className="mb-12">
              ...
              <h3 className="text-xl font-semibold mt-6 mb-3">
                8.1 LogiVox Property
              </h3>
              <p className="text-muted-foreground">
                The Service, including all software, designs, text, graphics,
                logos, and trademarks, is owned by LogiVox and protected by
                copyright, trademark, and other intellectual property laws. All
              ...
              <p className="text-muted-foreground">
                "LogiVox" and associated logos are trademarks of LogiVox Inc.
              ...
              <p className="text-muted-foreground">
                ...
                Service, you grant LogiVox a perpetual, irrevocable, worldwide,
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                LogiVox may integrate with third-party services (ERP systems,
                payment processors, analytics tools). Your use of third-party
                services is subject to their own terms and privacy policies.
                LogiVox is not responsible for third-party services.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                . By using the Service, you consent to our privacy practices as
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                LogiVox warrants that the Service will perform substantially as
                described in our documentation. If the Service does not conform
                to this warranty, your sole remedy is for LogiVox to use
                commercially reasonable efforts to correct the issue.
              </p>
              ...
              <p className="text-muted-foreground font-semibold uppercase">
                EXCEPT AS EXPRESSLY PROVIDED, THE SERVICE IS PROVIDED "AS IS"
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground font-semibold uppercase mb-3">
                TO THE MAXIMUM EXTENT PERMITTED BY LAW, LOGIVOX SHALL NOT BE
                LIABLE FOR:
              </p>
              ...
              <p className="text-muted-foreground mt-4">
                IN NO EVENT SHALL LOGIVOX'S TOTAL LIABILITY EXCEED THE AMOUNT
                YOU PAID TO LOGIVOX IN THE 12 MONTHS PRECEDING THE CLAIM.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                You agree to indemnify, defend, and hold harmless LogiVox, its
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                or using the cancellation feature in your Account settings.
              </p>
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                California, in accordance with the American Arbitration
              ...
              <p className="text-muted-foreground">
                ...
                not as a class action, class arbitration, or other
            ...
            <div className="mb-12">
              ...
              <p className="text-muted-foreground">
                ...
                LogiVox may assign these Terms at any time.
              </p>
              ...
              <p className="text-muted-foreground">
                LogiVox is not liable for failures or delays due to
