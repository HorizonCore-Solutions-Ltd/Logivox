  ...
  const continuityFeatures = [
    {
      ...
      description: "Industry-leading uptime guarantee with less than 4.38 hours of downtime per year. Redundant infrastructure ensures continuous operations.",
      badge: "Guaranteed"
    },
    {
      icon: RefreshCw,
      title: "Automated Failover",
      description: "Instant automatic failover to backup systems within seconds. Zero manual intervention required for seamless continuity.",
      badge: "Real-Time"
    },
    {
      icon: Database,
      title: "Real-Time Backups",
      description: "Continuous data replication with point-in-time recovery. Your data backed up every 5 minutes to multiple locations.",
      badge: "Continuous"
    },
    {
      icon: Globe,
      title: "Multi-Region Redundancy",
      description: "Data centers across multiple geographic regions. Active-active configuration ensures service availability even during regional outages.",
      badge: "Global"
    },
    {
      icon: HardDrive,
      title: "Disaster Recovery",
      description: "Comprehensive disaster recovery plan with 15-minute RPO and 1-hour RTO. Tested quarterly to ensure readiness.",
      badge: "Tested"
    },
    {
      icon: Activity,
      title: "Health Monitoring",
      description: "24/7 automated monitoring with proactive alerts. Issues detected and resolved before they impact your operations.",
      badge: "24/7"
    }
  ]
  ...
  const recoveryMetrics = [
    {
      metric: "RPO",
      value: "15 minutes",
      description: "Recovery Point Objective - Maximum data loss in disaster scenario",
      icon: Database
    },
    {
      metric: "RTO",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container-enterprise">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Enterprise-grade reliability with automated failover, real-time backups, multi-region redundancy, 
              and comprehensive disaster recovery. Your warehouse never stops.
            </p>
      ...
      <section className="py-20 lg:py-28">
        <div className="container-enterprise">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Enterprise-Grade Reliability</h2>
              ...
              return (
                <Card key={item.metric} className="text-center">
                  <CardHeader>
                    ...
                    <div className="text-sm text-muted-foreground font-medium mb-2">{item.metric}</div>
      ...
      <section className="py-20 lg:py-28">
        <div className="container-enterprise">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Redundant Infrastructure</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
        ...
        <div className="container-enterprise">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Business continuity isn't optional in modern warehousing. Downtime means lost orders, 
                unhappy customers, and revenue impact. Our advanced business continuity ensures your 
            ...
            <div className="space-y-6">
              <Card className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 border-red-200 dark:border-red-800">
                <CardHeader>
                  ...
                  <CardTitle className="text-red-900 dark:text-red-100">Without Business Continuity</CardTitle>
                  <CardDescription className="text-red-700 dark:text-red-200">
                    Average cost of downtime: $5,600 per minute. A single hour of downtime can cost $336,000 in lost revenue and productivity.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 border-green-200 dark:border-green-800">
                <CardHeader>
                  ...
                  <CardTitle className="text-green-900 dark:text-green-100">With LogiVox</CardTitle>
                  <CardDescription className="text-green-700 dark:text-green-200">
                    99.99% uptime means only 52 minutes of downtime per year. Automated failover happens in seconds, minimizing any impact to operations.
                  </CardDescription>
                </CardHeader>
              </Card>
            </div>
          ...
          <Card className="bg-gradient-to-br from-primary-600 to-primary-500 text-white border-0">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl text-primary-50 mb-8 max-w-2xl mx-auto">
                Get enterprise-grade business continuity with 99.99% uptime SLA, automated failover, 
                and comprehensive disaster recovery.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
