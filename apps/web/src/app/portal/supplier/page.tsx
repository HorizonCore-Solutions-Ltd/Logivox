    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">
            Manage shipments and create Advanced Shipping Notices (ASNs).
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter a Purchase Order ID or Number to begin.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex gap-4">
            ...
            <Button onClick={handleSearch} disabled={loading}>
              {loading ? (
                ...
                <>
                  <Search className="mr-2 h-4 w-4" /> Find PO
                </>
              )}
            </Button>
          </div>
        ...
        <Card className="animate-in fade-in slide-in-from-bottom-4 duration-500">
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                <CardTitle>
                  PO Details: {poData.poNumber || poData.id}
                </CardTitle>
                <CardDescription>
            ...
            <div className="mt-8 flex justify-end">
              <Button size="lg" onClick={handleSubmitASN} disabled={submitting}>
                {submitting ? (
                  ...
                  <>
                    <Truck className="mr-2 h-4 w-4" /> Submit ASN
                  </>
                )}
              </Button>
            </div>
