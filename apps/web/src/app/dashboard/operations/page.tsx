    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {metrics.receiving.todayReceived}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {metrics.shipping.ordersShipped}
            </div>
            <p className="text-xs text-muted-foreground">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Progress
              value={metrics.shipping.onTimeDelivery}
              className="mt-2"
            />
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {metrics.receiving.avgProcessingTime} min
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {metrics.picking.avgPickTime} min
              </span>
            </div>
            <div className="flex justify-between items-center">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium">
                {metrics.shipping.avgShipTime} min
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-muted-foreground">
              ...
              <Badge variant="outline">
                {metrics.shipping.pendingShipments}
              </Badge>
            </div>
            <Button
              variant="outline"
