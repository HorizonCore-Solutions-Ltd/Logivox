...
const DEMO_DEVICES: FleetDevice[] = [
  {
    ...
    status: "ACTIVE",
    batteryLevel: 78,
    currentLocation: "Aisle A-07",
    utilizationPct: 82,
    tasksCompletedToday: 34,
    uptimeHours: 6.5,
  },
  {
    id: "D2",
  ...
  },
  {
    ...
    status: "CHARGING",
    batteryLevel: 23,
    currentLocation: "Charging Station 1",
    utilizationPct: 0,
    tasksCompletedToday: 41,
    uptimeHours: 7.1,
  },
  {
    id: "D5",
    ...
    status: "ACTIVE",
    batteryLevel: 88,
    currentLocation: "Rack Row B",
    utilizationPct: 90,
    tasksCompletedToday: 52,
    uptimeHours: 7.8,
  },
  {
    id: "D6",
  ...
  },
  {
    ...
    status: "ACTIVE",
    batteryLevel: null,
    currentLocation: "Pack Station 1",
    utilizationPct: 95,
    tasksCompletedToday: 112,
    uptimeHours: 8.0,
  },
  {
    id: "D8",
  ...
  },
  {
    ...
    status: "ACTIVE",
    batteryLevel: null,
    currentLocation: "Palletizing Station",
    utilizationPct: 88,
    tasksCompletedToday: 67,
    uptimeHours: 7.5,
  },
];
...
const DEMO_TASKS: FleetTask[] = [
  {
    ...
    status: "IN_PROGRESS",
    deviceId: "D1",
    deviceName: "AMR-Alpha-01",
    sourceLocation: "A-07-B",
    destinationLocation: "PACK-01",
    estimatedDuration: 8,
  ...
  },
  {
    ...
    deviceId: "D5",
    deviceName: "AGV-01",
    sourceLocation: "RECV-01",
    destinationLocation: "B-12-A",
  ...
  },
  {
    ...
    deviceId: null,
    deviceName: null,
    sourceLocation: "C-03-C",
    destinationLocation: "PACK-02",
    estimatedDuration: 7,
  ...
  },
  {
    ...
    deviceId: null,
    deviceName: null,
    sourceLocation: "BULK-04",
    destinationLocation: "F-01-A",
...
const DEMO_SUGGESTIONS: DispatchSuggestion[] = [
  {
    ...
    sourceLocation: "C-03-C",
    destinationLocation: "PACK-02",
    suggestedDeviceId: "D3",
    suggestedDeviceName: "AMR-Alpha-03",
  },
  {
    taskId: "T4",
    taskType: "REPLENISHMENT",
    ...
    sourceLocation: "BULK-04",
    destinationLocation: "F-01-A",
    suggestedDeviceId: "D6",
    suggestedDeviceName: "AGV-02",
  },
  {
    taskId: "T5",
    taskType: "PICK",
    ...
    suggestedDeviceName: "No idle device available",
  },
];
...
const DEMO_SUMMARY: FleetSummary = {
  ...
  maintenance: DEMO_DEVICES.filter(
    (d) => d.status === "MAINTENANCE" || d.status === "ERROR",
  ).length,
  avgUtilizationPct: Math.round(
    DEMO_DEVICES.reduce((s, d) => s + d.utilizationPct, 0) /
      DEMO_DEVICES.length,
  ),
...
export default function FleetPage() {
  ...
  const [selectedDevice, setSelectedDevice] = useState<FleetDevice | null>(
    null,
  );
    ...
    try {
      ...
      if (res.ok) {
        toast({
          ...
          description: `${taskType} task sent to device`,
        });
        fetchData();
      }
    } catch {
  ...
  const sendCustomDispatch = () => {
    ...
    dispatchTask(
      selectedDevice.id,
      customTask.taskType,
      customTask.sourceLocation || null,
      customTask.destinationLocation || null,
      Number(customTask.priority),
    );
  ...
  const barData = dDevices
    .filter((d) => d.tasksCompletedToday > 0)
    .map((d) => ({
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Real-time fleet status · Task dispatch · Battery management ·
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <Card
          className={
            dSummary.maintenance > 0 ? "border-orange-200 bg-orange-50" : ""
          }
        >
          <CardContent className="pt-4">
            <p className="text-xs text-muted-foreground">Maintenance</p>
            <p
              className={`text-3xl font-bold ${dSummary.maintenance > 0 ? "text-orange-600" : "text-gray-400"}`}
            >
              {dSummary.maintenance}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-4">
            ...
            <p className="text-3xl font-bold text-blue-600">
              {dSummary.totalTasksToday}
            </p>
          </CardContent>
        </Card>
        <Card
          className={
            dSummary.queuedTasks > 0 ? "border-orange-200 bg-orange-50" : ""
          }
        >
          <CardContent className="pt-4">
            <p className="text-sm text-muted-foreground">Queued Tasks</p>
            <p
              className={`text-3xl font-bold ${dSummary.queuedTasks > 0 ? "text-orange-600" : "text-gray-400"}`}
            >
              {dSummary.queuedTasks}
            </p>
          </CardContent>
        </Card>
        <Card>
      ...
      <Tabs defaultValue="fleet">
        <TabsList>
          ...
          <TabsTrigger value="dispatch">
            Dispatch Queue
            {dSummary.queuedTasks > 0 && (
              <Badge className="ml-1.5 text-xs bg-orange-500">
                {dSummary.queuedTasks}
              </Badge>
            )}
          </TabsTrigger>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {dDevices.map((device) => {
              ...
              return (
                <Card
                  key={device.id}
                  className={`border-2 ${cfg.bg} transition-all`}
                >
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <span className="text-xl">
                          {DEVICE_TYPE_ICON[device.deviceType] ?? "🔧"}
                        </span>
                        <div>
                  ...
                  <CardContent className="space-y-2">
                    ...
                    {device.batteryLevel !== null && (
                      <div className="flex items-center gap-2">
                        ...
                        <Progress
                          ...
                          className={`h-2 flex-1 ${isLowBattery ? "bg-red-100" : ""}`}
                        />
                        <span
                          className={`text-xs font-bold ${isLowBattery ? "text-red-600" : "text-gray-600"}`}
                        >
                          {device.batteryLevel}%
                        </span>
                      </div>
                    ...
                    {device.status === "IDLE" && (
                      <Button
                        ...
                        onClick={() => openCustomDispatch(device)}
                      >
        ...
        <TabsContent value="dispatch" className="mt-4 space-y-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Optimal device matched to each queued task based on type +
                proximity
              </CardDescription>
            </CardHeader>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">
                      {sug.sourceLocation ?? "—"} →{" "}
                      {sug.destinationLocation ?? "—"}
                    </p>
                  </div>
                  <div className="text-right text-xs">
                    <p className="font-medium text-gray-700">
                      {sug.suggestedDeviceName}
                    </p>
                    {!sug.suggestedDeviceId && (
                      <p className="text-red-400">No device available</p>
                    )}
                  </div>
                  <Button
                    size="sm"
                    disabled={
                      !sug.suggestedDeviceId ||
                      dispatching === sug.suggestedDeviceId
                    }
            ...
            <CardContent>
              <div className="space-y-2">
                {dTasks.map((task) => (
                  <div
                    key={task.id}
                    className={`flex items-center gap-3 p-3 rounded-lg border text-sm ${task.status === "IN_PROGRESS" ? "border-green-200 bg-green-50" : "border-gray-200 bg-gray-50"}`}
                  >
                    <Badge
                      variant={
                        task.status === "IN_PROGRESS" ? "default" : "outline"
                      }
                      className={`text-xs ${task.status === "IN_PROGRESS" ? "bg-green-100 text-green-800" : ""}`}
                    >
        ...
        <TabsContent value="analytics" className="mt-4">
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">
                Tasks Completed Today — Per Device
              </CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <BarChart data={barData} layout="vertical">
                  ...
                  <Tooltip
                    formatter={(v: number, name: string) => [
                      v,
                      name === "tasks" ? "Tasks Completed" : "Utilization %",
                    ]}
                  />
      ...
      <Dialog open={customDialogOpen} onOpenChange={setCustomDialogOpen}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Assign a manual task to this device
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3 mt-2">
            <div>
              ...
              <Select
                value={customTask.taskType}
                onValueChange={(v) =>
                  setCustomTask((t) => ({ ...t, taskType: v }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div>
              ...
              <Input
                placeholder="e.g. A-07-B"
                value={customTask.sourceLocation}
                onChange={(e) =>
                  setCustomTask((t) => ({
                    ...t,
            ...
            <div>
              ...
              <Input
                ...
                value={customTask.destinationLocation}
                onChange={(e) =>
                  setCustomTask((t) => ({
                    ...t,
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setCustomTask((t) => ({ ...t, priority: e.target.value }))
                }
              />
            </div>
          </div>
          <Button
            ...
            disabled={dispatching === selectedDevice?.id}
            onClick={sendCustomDispatch}
          >
