...
export default function SustainabilityDashboard() {
  ...
  const carbonTrendData = footprints
    ...
    .reverse()
    .map((f) => ({
      date: new Date(f.timestamp).toLocaleDateString("en-US", {
        month: "short",
        day: "numeric",
      }),
      co2e: f.totalCO2e,
  ...
  const breakdownData = [
    {
      name: "Transportation",
      value: footprints.reduce((sum, f) => sum + f.breakdown.transportation, 0),
      color: "#ef4444",
    },
    {
      name: "Packaging",
      value: footprints.reduce((sum, f) => sum + f.breakdown.packaging, 0),
      color: "#f59e0b",
    },
    {
      name: "Warehousing",
      value: footprints.reduce((sum, f) => sum + f.breakdown.warehousing, 0),
      color: "#3b82f6",
    },
    {
      name: "Manufacturing",
      value: footprints.reduce((sum, f) => sum + f.breakdown.manufacturing, 0),
      color: "#8b5cf6",
    },
  ];
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">
                Current: {(metrics.totalCO2e / 1000).toFixed(1)}t CO₂e
              </span>
              <span className="font-medium text-green-600">
                {currentProgress > 0
                  ? `${currentProgress.toFixed(0)}% below target`
                  : `${Math.abs(currentProgress).toFixed(0)}% above target`}
              </span>
            </div>
            <Progress
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Progress
                    value={metrics.recyclingRate * 100}
                ...
                <div>
                  ...
                  <Progress
                    value={metrics.sustainablePackaging * 100}
                ...
                <div>
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="font-medium">
                      {(metrics.wasteReduction * 100).toFixed(0)}%
                    </span>
                  </div>
                  <Progress
                    value={metrics.wasteReduction * 100}
        ...
        <TabsContent value="breakdown" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Stacked area chart of carbon sources
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="recommendations" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI recommendations to reduce carbon footprint (
