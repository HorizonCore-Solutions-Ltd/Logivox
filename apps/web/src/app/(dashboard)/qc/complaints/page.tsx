...
const MOCK: Complaint[] = [
  {
    ...
    description: "Customer received unit with cracked housing.",
    status: "INVESTIGATING",
    priority: "HIGH",
    reportedBy: "Customer Support",
    assignedTo: "QA Engineer",
    productSku: "SKU-UNIT-A1",
  ...
  },
  {
    ...
    assignedTo: "Process Lead",
    productSku: null,
    createdAt: "2026-02-15T09:00:00Z",
    resolvedAt: "2026-02-22T11:00:00Z",
    resolution: "SOP updated and team retrained.",
  },
  {
    id: "3",
    ...
    description: "Missing required safety symbol on product label.",
    status: "CLOSED",
    priority: "HIGH",
    reportedBy: "Regulatory Affairs",
    assignedTo: "Packaging Team",
    productSku: "SKU-LABEL-X",
    createdAt: "2026-01-20T08:00:00Z",
    resolvedAt: "2026-02-01T16:00:00Z",
    resolution: "Label redesigned and approved. All stock relabeled.",
  },
];
...
export default function ComplaintsPage() {
  ...
  useEffect(() => {
    fetch("/api/qc/complaints")
      ...
      .then((d) =>
        setComplaints(
          Array.isArray(d.complaints ?? d) ? (d.complaints ?? d) : MOCK,
        ),
      )
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600">
              Track customer, internal, regulatory, and supplier complaints
              through resolution.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            { label: "Active", value: stats.open, color: "text-red-600" },
            {
              label: "High Priority",
              value: stats.high,
              color: "text-red-700",
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex gap-2 mb-1 flex-wrap items-center">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded-full text-xs font-semibold ${SRC_COLOR[c.source]}`}
                        >
                          {c.source}
                        </span>
                        <span
