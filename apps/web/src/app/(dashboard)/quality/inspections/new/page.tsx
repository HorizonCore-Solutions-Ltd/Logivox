      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Initiate a quality control check for inbound or existing inventory.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Select the item to inspect and the protocol to follow.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {isLoadingInventory ? (
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormData({ ...formData, inventoryId: val })
                  }
                >
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="quantity">
                  Quantity to Inspect <span className="text-red-500">*</span>
                </Label>
                <Input
                  id="quantity"
                  type="number"
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                If no template is selected, the system default will be applied.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setFormData({ ...formData, referenceType: val })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
