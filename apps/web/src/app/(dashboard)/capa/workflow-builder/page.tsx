  ...
  const fetchTemplates = async () => {
    try {
      const response = await fetch(
        "/api/capa/workflow-builder?action=templates",
      );
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Build custom CAPA workflows without coding - drag, drop, automate!
        </p>
      </div>
        ...
        {workflows.length === 0 ? (
          <div className="text-center py-12 text-gray-500">
            ...
            <div className="text-sm">
              Start by creating one from a template above
            </div>
          </div>
        ) : (
      ...
      <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
          <div>
            ...
            <ul className="space-y-1 text-purple-800">
              <li>
                • <strong>Start/End:</strong> Workflow triggers and completion
              </li>
              <li>
                • <strong>Approval:</strong> Multi-level approval chains
              </li>
              <li>
                • <strong>Condition:</strong> If/then/else logic branching
              </li>
              <li>
                • <strong>Auto-Action:</strong> Automated status updates,
                assignments
              </li>
              <li>
                • <strong>Notification:</strong> Email, SMS, in-app alerts
              </li>
              <li>
                • <strong>Delay:</strong> Wait periods (days, hours)
              </li>
              <li>
                • <strong>Training:</strong> Auto-create training requirements
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-purple-800">
              <li>
                • <strong>Priority Escalation:</strong> Auto-notify executives
                for critical issues
              </li>
              <li>
                • <strong>Supplier Workflows:</strong> Request 8D reports, track
                responses
              </li>
              <li>
                • <strong>Multi-Approval:</strong> Supervisor → Director → CFO
                chains
              </li>
              <li>
                • <strong>Training Integration:</strong> Auto-create courses
                from CAPAs
              </li>
              <li>
                • <strong>Status Automation:</strong> Update status based on
                actions
              </li>
              <li>
                • <strong>Smart Routing:</strong> Route CAPAs by department,
                severity
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1 text-purple-800">
              <li>
                • <strong>Manufacturing:</strong> Quality defect escalation
              </li>
              <li>
                • <strong>Supplier Management:</strong> Automated 8D requests
              </li>
              <li>
                • <strong>Compliance:</strong> FDA-compliant approval chains
              </li>
              <li>
                • <strong>Training:</strong> Auto-create lessons from incidents
              </li>
              <li>
                • <strong>Finance:</strong> Cost-based approval routing
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-6 pt-6 border-t border-purple-300">
          <div className="text-sm text-purple-800">
            <strong>💰 ROI Impact:</strong> $124K investment → $450K annual
            savings (363% ROI) through workflow automation, reduced approval
            delays, and consistent process execution across all CAPAs.
          </div>
        </div>
      </div>
    </div>
