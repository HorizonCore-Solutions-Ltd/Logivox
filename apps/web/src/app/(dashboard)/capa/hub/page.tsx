...
const CAPA_SYSTEMS: SystemCard[] = [
  {
    ...
    savings: '$580K',
    roi: '866%',
    features: ['Real-time KPIs', 'Trend analysis', 'Executive reports', 'Performance metrics'],
    status: 'active'
  },
  {
    id: 2,
    ...
    savings: '$450K',
    roi: '1,046%',
    features: ['Impact severity', 'Customer notifications', 'Resolution tracking', 'Satisfaction scores'],
    status: 'active'
  },
  {
    id: 3,
    ...
    savings: '$620K',
    roi: '1,107%',
    features: ['Cost categories', 'Savings validation', 'ROI analysis', 'Budget tracking'],
    status: 'active'
  },
  {
    id: 4,
    ...
    savings: '$320K',
    roi: '842%',
    features: ['5 Whys analysis', 'AI validation', 'Pattern detection', 'Quality scoring'],
    status: 'active'
  },
  {
    id: 5,
    ...
    savings: '$780K',
    roi: '1,083%',
    features: ['Pattern matching', 'Similarity detection', 'Trend analysis', 'Proactive alerts'],
    status: 'active'
  },
  {
    id: 6,
    ...
    savings: '$1.2M',
    roi: '1,348%',
    features: ['Supplier scoring', '8D reports', 'Performance tracking', 'Risk assessment'],
    status: 'active'
  },
  {
    id: 7,
    ...
    savings: '$890K',
    roi: '664%',
    features: ['ML predictions', 'Historical analysis', 'Confidence scoring', 'Pattern learning'],
    status: 'active'
  },
  {
    id: 8,
    ...
    savings: '$380K',
    roi: '844%',
    features: ['Smart reminders', 'Auto-escalation', 'Task tracking', 'Performance monitoring'],
    status: 'active'
  },
  {
    id: 9,
    ...
    savings: '$670K',
    roi: '859%',
    features: ['Pareto charts', 'Time series', 'Statistical analysis', 'Predictive trends'],
    status: 'active'
  },
  {
    id: 10,
    ...
    savings: '$2.8M',
    roi: '3,077%',
    features: ['Auto-training creation', 'Effectiveness tracking', 'Completion monitoring', 'Skill gaps'],
    status: 'active'
  },
  {
    id: 11,
    ...
    savings: '$420K',
    roi: '778%',
    features: ['Version control', 'Access control', 'Audit trail', 'Quick search'],
    status: 'active'
  },
  {
    id: 12,
    ...
    savings: '$3.2M',
    roi: '3,106%',
    features: ['Multi-method verification', '30-day observation', 'Recurrence tracking', 'Success scoring'],
    status: 'active'
  },
  {
    id: 13,
    ...
    savings: '$275K',
    roi: '529%',
    features: ['FMEA methodology', 'S×O×D calculation', 'Auto-prioritization', 'Risk reduction tracking'],
    status: 'active'
  },
  {
    id: 14,
  ...
  },
  {
    ...
    savings: '$290K',
    roi: '433%',
    features: ['14 automated checks', 'Completion scoring', 'Critical validation', 'Manager override'],
    status: 'active'
  },
  {
    id: 17,
    ...
    savings: '$210K',
    roi: '276%',
    features: ['14 languages', 'RTL support', 'Regional compliance', 'Auto-translation'],
    status: 'active'
  },
  {
    id: 18,
    ...
    savings: '$450K',
    roi: '363%',
    features: ['5 templates', 'Conditional logic', 'Auto-actions', 'Visual designer'],
    status: 'active'
  }
]
...
export default function CAPASystemsHubPage() {
  ...
  const filteredSystems = CAPA_SYSTEMS.filter(system => {
    const matchesCategory = selectedCategory === 'All Systems' || system.category === selectedCategory
  ...
  // Calculate totals
  const totalInvestment = CAPA_SYSTEMS.reduce((sum, s) => sum + parseFloat(s.investment.replace('$', '').replace('K', '')), 0)
  const totalSavings = CAPA_SYSTEMS.reduce((sum, s) => {
    const value = s.savings.replace('$', '').replace('M', '').replace('K', '')
    return sum + (s.savings.includes('M') ? parseFloat(value) * 1000 : parseFloat(value))
  }, 0)
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-lg">
              18 Advanced Quality Management Systems - All Complete & Production Ready
            </p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white bg-opacity-10 rounded-lg p-4">
            <div className="text-2xl font-bold">${totalInvestment.toFixed(0)}K</div>
            <div className="text-blue-100 text-sm">Total Investment</div>
          </div>
          <div className="bg-white bg-opacity-10 rounded-lg p-4">
            <div className="text-2xl font-bold">${(totalSavings / 1000).toFixed(1)}M</div>
        ...
        {filteredSystems.map((system) => (
          <Link key={system.id} href={system.route}>
            <div className="bg-white border rounded-lg p-6 hover:shadow-lg hover:border-blue-400 transition-all cursor-pointer h-full">
              ...
              {/* Content */}
              <div className="text-xs text-gray-500 mb-1">System {system.id} of 18</div>
              ...
              <div className="border-t pt-3 flex justify-between items-center">
                ...
                <div>
                  ...
                  <div className="font-bold text-sm text-green-600">{system.savings}</div>
                </div>
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          <div>
            <div className="font-bold text-2xl text-green-700">{CAPA_SYSTEMS.filter(s => s.status === 'active').length}</div>
      ...
      <div className="bg-white border rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {CATEGORIES.filter(cat => cat !== 'All Systems').map(category => {
            const count = CAPA_SYSTEMS.filter(s => s.category === category).length
            return (
              <button
                key={category}
