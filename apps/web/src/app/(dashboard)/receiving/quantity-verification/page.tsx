...
export default function QuantityVerificationPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      const [statsRes, verificationsRes, discrepanciesRes] = await Promise.all([
        ...
        fetch('/api/receiving/quantity-verification?action=active-verifications'),
        fetch('/api/receiving/quantity-verification?action=recent-discrepancies'),
      ]);
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading quantity verification data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Quantity Verification</h1>
            ...
            {activeVerifications.length === 0 ? (
              ...
              <div className="space-y-4">
                {activeVerifications.map((verification) => {
                  ...
                  const variancePercentage = verification.variancePercentage || 0;
                    ...
                    >
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            Supplier: {verification.receiving?.supplier?.name || 'N/A'}
                          </div>
                        </div>
                      ...
                      {verification.method === 'STATISTICAL_SAMPLE' && (
                        <div className="p-3 bg-blue-50 border border-blue-200 rounded mb-3">
                          ...
                          <div className="text-xs text-blue-700 mt-1">
                            Confidence: {verification.confidence || 95}% • Margin of
                            Error: ±{verification.marginOfError || 0}%
                          </div>
                        </div>
                      )}
                        ...
                        verification.discrepancies.length > 0 && (
                          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded">
                            <div className="text-sm text-yellow-800 font-medium">
                              ...
                              {verification.discrepancies.length === 1 ? 'y' : 'ies'}{' '}
                              Found
                            </div>
                      ...
                      <div className="mt-3 pt-3 border-t border-gray-200 flex justify-between items-center">
                        <div className="text-xs text-gray-500">
                          Started: {new Date(verification.startedAt).toLocaleString()}
                        </div>
                    ...
                    {recentDiscrepancies.map((discrepancy) => (
                      <tr key={discrepancy.id} className="hover:bg-gray-50">
                        <td className="px-4 py-3">
                          <Badge
                            className={getDiscrepancyTypeColor(discrepancy.type)}
                          >
                            {discrepancy.type}
                          </Badge>
                        </td>
                        ...
                        <td className="px-4 py-3 text-sm">
                          {discrepancy.verification?.receiving?.supplier?.name ||
                            'N/A'}
                        </td>
                        <td className="px-4 py-3">
                          <span
                        ...
                        <td className="px-4 py-3 text-sm text-gray-500">
                          {new Date(discrepancy.detectedAt).toLocaleDateString()}
                        </td>
                      </tr>
                    ))}
                  </tbody>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Physical count by hand. Most accurate but time-consuming. Best for
                small quantities (&lt;50 units) or high-value items.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">When to Use</div>
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Count a sample, extrapolate to total. Reduces time by 80% for large
                shipments. Uses AQL sampling standards (50-315 sample size).
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">When to Use</div>
                <div className="text-sm text-blue-900">
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Quick visual check without detailed count. Only for highly trusted
                suppliers (98%+ accuracy) with small quantities.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">When to Use</div>
                <div className="text-sm text-blue-900">
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                System automatically recommends optimal verification method based on
                quantity, item type, supplier accuracy, and barcoding availability.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
          ...
          <Card className="p-6 bg-gradient-to-r from-green-50 to-blue-50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="text-2xl font-bold text-purple-600">3.5 months</div>
              </div>
            </div>
