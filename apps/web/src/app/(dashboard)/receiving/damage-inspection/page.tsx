      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">
            Loading damage inspection data...
          </p>
        </div>
      </div>
    );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="p-4">
          ...
          <div className="text-xs text-gray-500 mt-1">
            {stats?.passedInspections || 0} passed,{" "}
            {stats?.damagedInspections || 0} damaged
          </div>
        </Card>
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          Supplier:{" "}
                          {inspection.receiving?.supplier?.name || "N/A"}
                        </div>
                      </div>
                      <Badge
                        className={
                    ...
                    {inspection.aiDamageDetected && (
                      <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded">
                        ...
                        <div className="text-xs text-yellow-700 mt-1">
                          Computer vision detected potential damage. Manual
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {recentDamages.map((damage) => (
                      <tr key={damage.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <Badge
                            className={getDamageSeverityColor(damage.severity)}
                          >
                            {damage.severity}
                          </Badge>
                        </td>
                        <td className="px-4 py-3 text-sm">
                          {damage.inspection?.receiving?.supplier?.name ||
                            "N/A"}
                        </td>
                        <td className="px-4 py-3 text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Advanced AI analyzes photos to automatically detect damage with
                95%+ accuracy. Supports cosmetic, structural, functional, and
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Integrated camera capture with guided workflows. AI validates
                photo quality and automatically tags damage locations with
                bounding boxes.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">Impact</div>
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                AI-powered severity assessment (minor to critical) based on
                damage type, extent, and functional impact. Auto-escalates
                critical issues.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">Impact</div>
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Automatically generates supplier claims with photographic
                evidence, damage reports, and estimated values. Tracks claim
                status and recovery.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">Impact</div>
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Tracks damage patterns by supplier, product category, and
                transport mode. Identifies recurring issues and high-risk
                shipments.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">Impact</div>
            ...
            <Card className="p-6">
              ...
              <p className="text-sm text-gray-600">
                Seamless integration with supplier portals and claims management
                systems. One-click claim submission with complete documentation
                package.
              </p>
              <div className="mt-4 p-3 bg-blue-50 rounded">
                <div className="text-xs text-blue-700 font-medium">Impact</div>
