                    ...
                    <>
                      <div className="space-y-2 text-sm mb-3">
                        <div>
                          ...
                          <span className="font-medium">{dock.shipment}</span>
                        </div>
                        <div>
                          <span className="text-gray-600">Carrier:</span>{" "}
                          <span className="font-medium">{dock.carrier}</span>
                        </div>
                        <div>
                          <span className="text-gray-600">Started:</span>{" "}
                          <span className="font-medium">{dock.startTime}</span>
                        </div>
                      </div>
                  ...
                  <div className="p-4 bg-gray-50 rounded">
                    ...
                    <ul className="text-sm space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong>75% faster check-in</strong> - Self-service
                          kiosk
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-600">✓</span>
                        <span>
                          <strong>100% paperless</strong> - Digital documents
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-600">✓</span>
                        <span>
                          <strong>Real-time visibility</strong> - Live updates
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border-2 border-green-300">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>10 Complete Systems</strong> - Scheduling,
                      Planning, Staging, Verification, Carrier Mgmt, Labels,
                      BOL, Dashboard, Analytics, Mobile
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 text-lg">✓</span>
                    <span>
                      <strong>100% Digital Transformation</strong> - Paperless
                      operations across all dock processes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 text-lg">✓</span>
                    <span>
                      <strong>Real-time Visibility</strong> - Live monitoring
                      and mobile access for all stakeholders
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 text-lg">✓</span>
                    <span>
                      <strong>Data-Driven Decisions</strong> - Advanced
