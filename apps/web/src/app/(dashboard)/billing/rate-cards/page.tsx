...
export default function RateCardsPage() {
  ...
  const activityTypes = [
    ...
    'SHIPPING', 'KITTING', 'RETURNS', 'VALUE_ADDED'
  ];
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-gray-900">{rateCards.length}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-gray-600">{inactiveCards}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage pricing for all warehouse activities</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
