...
const DEMO_ENTRIES: GateEntry[] = [
  {
    id: "1",
    entryNumber: "GATE-A1B2C",
    entryType: "DELIVERY",
    direction: "INBOUND",
    gateNumber: "G1",
    vehicleType: "TRUCK",
    vehicleNumber: "TRK-441",
    licensePlate: "ABC-1234",
    trailerNumber: "TRL-7721",
    driverName: "James Hawkins",
    carrierName: "Swift Freight",
    scheduledTime: new Date(Date.now() - 8 * 60000).toISOString(),
    actualTime: new Date(Date.now() - 5 * 60000).toISOString(),
  ...
  {
    id: "2",
    entryNumber: "GATE-D3E4F",
    entryType: "PICKUP",
    direction: "OUTBOUND",
    gateNumber: "G2",
    vehicleType: "TRUCK",
    vehicleNumber: "TRK-882",
    licensePlate: "XYZ-5678",
    driverName: "Maria Santos",
    carrierName: "FedEx Freight",
    actualTime: new Date(Date.now() - 22 * 60000).toISOString(),
    securityCheckPassed: true,
  ...
  {
    id: "3",
    entryNumber: "GATE-G5H6I",
    entryType: "DELIVERY",
    direction: "INBOUND",
    gateNumber: "G1",
    vehicleType: "VAN",
    vehicleNumber: "VAN-119",
    licensePlate: "DEF-9012",
    driverName: "Tom Bradley",
    carrierName: "UPS Supply Chain",
    actualTime: new Date(Date.now() - 45 * 60000).toISOString(),
    securityCheckPassed: false,
    securityNotes: "Driver ID mismatch — supervisor alerted",
  },
  {
    id: "4",
    entryNumber: "GATE-J7K8L",
    entryType: "DELIVERY",
    direction: "INBOUND",
    gateNumber: "G3",
    vehicleType: "TRUCK",
    vehicleNumber: "TRK-334",
    licensePlate: "GHI-3456",
    trailerNumber: "TRL-4409",
    driverName: "Priya Nair",
    carrierName: "DHL Supply",
    scheduledTime: new Date(Date.now() - 60 * 60000).toISOString(),
    actualTime: new Date(Date.now() - 58 * 60000).toISOString(),
    securityCheckPassed: true,
  ...
  {
    id: "5",
    entryNumber: "GATE-M9N0O",
    entryType: "PICKUP",
    direction: "OUTBOUND",
    gateNumber: "G2",
    vehicleType: "TRUCK",
    vehicleNumber: "TRK-775",
    licensePlate: "JKL-7890",
    trailerNumber: "TRL-8832",
    driverName: "Carlos Ortiz",
    carrierName: "Walmart Fleet",
    actualTime: new Date(Date.now() - 90 * 60000).toISOString(),
    securityCheckPassed: true,
...
const DEMO_YARD_LOCATIONS: YardLocation[] = [
  {
    ...
    activeAppointment: {
      appointmentNumber: "APT-001",
      appointmentType: "INBOUND_RECEIPT",
      status: "IN_PROGRESS",
      carrierName: "Swift Freight",
      vehicleNumber: "TRK-441",
      trailerNumber: "TRL-7721",
  ...
  },
  {
    id: "L2",
    locationCode: "DOC-02",
    locationName: "Dock Door 2",
    locationType: "DOCK_DOOR",
    isOccupied: true,
    capacity: 1,
    activeAppointment: {
      appointmentNumber: "APT-002",
      appointmentType: "OUTBOUND_SHIPMENT",
      status: "IN_PROGRESS",
      carrierName: "FedEx Freight",
      vehicleNumber: "TRK-882",
    },
  ...
  {
    id: "L10",
    locationCode: "STAGE-1",
    locationName: "Staging Area 1",
    locationType: "STAGING",
    isOccupied: true,
    capacity: 4,
    activeAppointment: {
      appointmentNumber: "APT-008",
      appointmentType: "CROSS_DOCK",
      status: "SCHEDULED",
      carrierName: "Walmart Fleet",
    },
  },
...
const DEMO_SHUNTER_TASKS: ShunterTask[] = [
  {
    ...
    fromLocation: "PRK-A1",
    toLocation: "DOC-03",
    scheduledStart: new Date(Date.now() + 8 * 60000).toISOString(),
    status: "PENDING",
  },
  {
    id: "SPOT-002",
    ...
    fromLocation: "DOC-04",
    toLocation: "PRK-A3",
    scheduledStart: new Date(Date.now() + 25 * 60000).toISOString(),
    status: "PENDING",
  },
  {
    id: "PULL-003",
    ...
    fromLocation: "PRK-A2",
    toLocation: "DOC-04",
    scheduledStart: new Date(Date.now() + 45 * 60000).toISOString(),
    status: "PENDING",
  },
];
...
export default function YardManagementPage() {
  ...
  const [shunterSummary, setShunterSummary] = useState<ShunterSummary | null>(
    null,
  );
  ...
  const dLocations =
    yardLocations.length > 0 ? yardLocations : DEMO_YARD_LOCATIONS;
  ...
  const parkingSpots = dLocations.filter(
    (l) => l.locationType === "PARKING_SPOT",
  );
  const stagingAreas = dLocations.filter((l) => l.locationType === "STAGING");

  const occupancyPct = Math.round(
    (dShunterSummary.occupiedSpots /
      Math.max(dShunterSummary.totalYardLocations, 1)) *
      100,
  );
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Gate log · Dock allocation · Shunter dispatch · Real-time yard
            visibility
            {lastUpdated && (
          ...
          <Dialog open={gateDialogOpen} onOpenChange={setGateDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Registers vehicle entry/exit and auto-links to any matching
                  appointment
                </DialogDescription>
              </DialogHeader>
              <div className="grid grid-cols-2 gap-3 mt-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setGateForm((f) => ({ ...f, driverName: e.target.value }))
                    }
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <Input
                    placeholder="TRL-0000"
                    value={gateForm.trailerNumber}
                    onChange={(e) =>
                      setGateForm((f) => ({
                        ...f,
                ...
                <div className="col-span-2 flex items-center gap-2 pt-1">
                  <input
                    type="checkbox"
                    id="security"
                    checked={gateForm.securityCheckPassed}
                    onChange={(e) =>
                      setGateForm((f) => ({
                        ...f,
                        securityCheckPassed: e.target.checked,
                      }))
                    }
                    className="w-4 h-4"
                  />
              ...
              <Button
                ...
                disabled={
                  checkingIn ||
                  (!gateForm.vehicleNumber && !gateForm.driverName)
                }
                onClick={checkInVehicle}
              >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-4">
          ...
          <CardContent className="pt-5">
            ...
            <div className="flex gap-2 mt-1 text-xs">
              <span className="text-green-600 flex items-center gap-0.5">
                ...
                {dGateSummary.inbound}
              </span>
              <span className="text-blue-600 flex items-center gap-0.5">
                <ArrowUpFromLine className="h-3 w-3" />
                {dGateSummary.outbound}
              </span>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-5">
            <p className="text-sm text-muted-foreground">
              Avg Check-In Variance
            </p>
            <p
              className={`text-3xl font-bold ${dGateSummary.avgCheckInVarianceMinutes > 15 ? "text-red-600" : dGateSummary.avgCheckInVarianceMinutes > 5 ? "text-yellow-600" : "text-green-600"}`}
            >
        ...
        <Card
          className={
            dGateSummary.securityChecksFail > 0
        ...
        >
          <CardContent className="pt-5">
            ...
            <p
              className={`text-3xl font-bold ${dGateSummary.securityChecksFail > 0 ? "text-red-600" : "text-green-600"}`}
            >
              {dGateSummary.securityChecksPass}
            </p>
            {dGateSummary.securityChecksFail > 0 && (
              <p className="text-xs text-red-500">
                {dGateSummary.securityChecksFail} failed
              </p>
            )}
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="pt-5">
            ...
            <p
              className={`text-3xl font-bold ${dShunterSummary.urgentTasks > 0 ? "text-orange-600" : ""}`}
            >
              {dShunterSummary.pendingShunterTasks}
            </p>
            {dShunterSummary.urgentTasks > 0 && (
              <p className="text-xs text-orange-600">
                {dShunterSummary.urgentTasks} urgent
              </p>
            )}
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-5">
            ...
            <p className="text-3xl font-bold text-teal-600">
              {dShunterSummary.availableSpots}
            </p>
            <p className="text-xs text-gray-400 mt-0.5">
              of {dShunterSummary.totalYardLocations} total
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="yard-map" className="space-y-4 mt-4">
          ...
          <div className="flex flex-wrap gap-4 text-sm">
            ...
            <div className="flex items-center gap-1.5">
              <div className="w-4 h-4 rounded border bg-white border-gray-200 flex items-center justify-center">
            ...
            <div className="flex items-center gap-1.5">
              <div className="w-4 h-4 rounded border bg-white border-gray-200 flex items-center justify-center">
                <Truck className="w-2.5 h-2.5 text-gray-600" />
              </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-6 gap-3">
              {dockDoors.map((loc) => (
                <div
                  key={loc.id}
                  className={`rounded-xl border-2 p-3 transition-all ${LOCATION_TYPE_COLOR[loc.locationType]} ${loc.isOccupied ? "opacity-100" : "opacity-60"}`}
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {loc.isOccupied ? (
                      ...
                      <span className="text-green-500 text-lg font-light">
                        ○
                      </span>
                    )}
                  </div>
                  {loc.activeAppointment ? (
                    <>
                      <p className="text-xs font-medium truncate">
                        {loc.activeAppointment.carrierName ?? "—"}
                      </p>
                      <p className="text-xs text-gray-500 truncate">
                        {loc.activeAppointment.trailerNumber ??
                          loc.activeAppointment.vehicleNumber}
                      </p>
                      <Badge
                        className="mt-1 text-xs px-1.5 py-0"
                        variant="outline"
                      >
                        {loc.activeAppointment.status?.replace("_", " ")}
                      </Badge>
                    </>
                  ) : (
              ...
              {parkingSpots.map((loc) => (
                ...
                >
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {loc.isOccupied ? (
                      <ParkingSquare className="h-4 w-4 text-gray-600" />
                    ) : (
                      <span className="text-green-500 text-lg font-light">
                        ○
                      </span>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {stagingAreas.map((loc) => (
                  <div
                    key={loc.id}
                    className={`rounded-xl border-2 p-3 ${LOCATION_TYPE_COLOR[loc.locationType]} ${loc.isOccupied ? "opacity-100" : "opacity-60"}`}
                  >
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-bold text-sm">
                        {loc.locationCode}
        ...
        <TabsContent value="shunter" className="mt-4">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                Trailers to be moved between parking spots and dock doors —
                accept to dispatch
              </CardDescription>
            </CardHeader>
            <CardContent>
              {dTasks.length === 0 ? (
                ...
                <div className="space-y-3">
                  {dTasks.map((task) => (
                    <div
                      key={task.id}
                      className={`flex items-center gap-4 p-4 rounded-lg border ${task.priority === "URGENT" ? "border-red-300 bg-red-50" : "border-gray-200 bg-gray-50"}`}
                    >
                      <div
                        className={`px-2 py-0.5 rounded text-xs font-bold border ${task.priority === "URGENT" ? "bg-red-100 text-red-700 border-red-300" : "bg-gray-100 text-gray-600 border-gray-300"}`}
                      >
                        {task.priority}
                      </div>
                      ...
                      <div className="text-right text-xs">
                        <p
                          className={`font-bold ${task.priority === "URGENT" ? "text-red-600" : "text-gray-600"}`}
                        >
                          {minsUntil(task.scheduledStart)}
                        </p>
        ...
        <TabsContent value="gate-log" className="mt-4">
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>
                All vehicle entries and exits with security verification status
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {dEntries.map((e) => (
                      <tr
                        key={e.id}
                        className={`border-b last:border-0 ${!e.securityCheckPassed ? "bg-red-50" : ""}`}
                      >
                        ...
                        <td className="py-2 pr-4">
                          <Badge
                            className={`text-xs ${e.direction === "INBOUND" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}`}
                          >
                            {e.direction === "INBOUND" ? (
                              <ArrowDownToLine className="h-3 w-3 mr-1 inline" />
                            ) : (
                              <ArrowUpFromLine className="h-3 w-3 mr-1 inline" />
                            )}
                            {e.direction}
                          </Badge>
                        </td>
