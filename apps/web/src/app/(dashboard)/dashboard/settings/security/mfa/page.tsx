...
export default function MFASettingsPage() {
  ...
  const [setupStep, setSetupStep] = useState<
    "initial" | "scan" | "verify" | "backup" | "complete"
  >("initial");
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                Each code can only be used once. Store them securely - you won't
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                You'll be asked for a verification code from your authenticator
