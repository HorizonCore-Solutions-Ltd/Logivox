    ...
    try {
      ...
      setStats({
        ...
        expiringSoon: list.filter(
          (c) =>
            c.status === "ACTIVE" && c.endDate && new Date(c.endDate) < in30,
        ).length,
  ...
  const createContract = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: data.contract?.contractNumber,
      });
      setShowCreate(false);
      setForm({
        customerId: "",
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Manage customer pricing contracts, credit limits, and payment
              terms
            </p>
          </div>
                ...
                <div className="grid grid-cols-2 gap-4 py-2">
                  ...
                  <div className="col-span-2 space-y-1">
                    ...
                    <Input
                      ...
                      placeholder="Annual Service Agreement 2026"
                    />
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      placeholder="GOLD / SILVER (optional)"
                    />
                  </div>
                  <div className="space-y-1">
              ...
              <Table>
                ...
                <TableBody>
                  {contracts.map((c) => {
                    ...
                    const creditRatio =
                      c.customer.creditLimit && c.customer.creditUsed
                        ? (Number(c.customer.creditUsed) /
                            Number(c.customer.creditLimit)) *
                          100
                        : null;
                    return (
                      <TableRow
                        key={c.id}
                        className={`hover:bg-muted/50 ${c.customer.creditHold ? "bg-red-50/30" : ""}`}
                      >
                        ...
                        <TableCell>
                          <div className="flex flex-col gap-1">
                            <Badge className={`text-xs ${sc.color} w-fit`}>
                              {sc.label}
                            </Badge>
                          ...
                          {c.customer.creditLimit ? (
                            <div>
                              <p className="text-xs font-mono">
                                {fmt(
                                  Number(c.customer.creditUsed ?? 0),
                                  c.currency,
                                )}{" "}
                                /{" "}
                                {fmt(
                              ...
                              {creditRatio !== null && (
                                <div className="w-20 h-1.5 bg-gray-200 rounded mt-1">
                                  <div
                                    ...
                                    style={{
                                      width: `${Math.min(creditRatio, 100)}%`,
                                    }}
                                  />
                                </div>
                              )}
                        ...
                        <TableCell>
                          {c.endDate ? (
                            <span
                              className={`text-sm ${expiring ? "text-amber-600 font-medium" : "text-muted-foreground"}`}
                            >
                              {expiring && (
                            ...
                            <span className="text-xs text-muted-foreground">
                              {c.autoRenew ? "Auto-renew" : "No expiry"}
                            </span>
                          )}
                        </TableCell>
                        <TableCell>
