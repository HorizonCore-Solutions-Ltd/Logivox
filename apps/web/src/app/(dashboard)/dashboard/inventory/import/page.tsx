...
export default function ImportInventoryPage() {
  ...
  const downloadTemplate = () => {
    const headers = "name,sku,quantity,unit,price,cost,description,binLocation,minStock,maxStock";
    const example = "Example Product,PROD-001,100,EA,19.99,10.00,Sample item description,A-01-01,10,200";
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Bulk upload inventory items using a CSV file. This is the fastest way to migrate your data.
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <ol className="list-decimal list-inside space-y-2 text-sm text-muted-foreground">
              ...
              <li>Required columns: <strong>name, sku, quantity, unit</strong>.</li>
              <li>Optional columns: price, cost, description, binLocation, minStock, maxStock.</li>
