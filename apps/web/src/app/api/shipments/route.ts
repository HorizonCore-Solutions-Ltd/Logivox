      ...
      async (tx: Prisma.TransactionClient) => {
        ...
        const shipment = await tx.shipment.create({
          data: {
            ...
            carrierName:
              carrierNames[validatedData.carrierCode] ||
              validatedData.carrierCode,
            carrierService: validatedData.carrierService,

            recipientName:
              validatedData.recipientName || salesOrder.customer.name,
            recipientPhone:
              validatedData.recipientPhone || salesOrder.customer.phone,
            recipientEmail:
              validatedData.recipientEmail || salesOrder.customer.email,
            addressLine1:
              validatedData.addressLine1 || salesOrder.shippingAddress,
