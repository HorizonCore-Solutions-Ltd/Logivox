...
const AQL_TABLE: Record<string, Record<string, number>> = {
  "0.65": { S1: 2, S2: 3, S3: 5, S4: 8, A: 13, B: 20, C: 32, D: 50, E: 80, F: 125, G: 200, H: 315 },
  "1.0":  { S1: 3, S2: 5, S3: 8, S4: 13, A: 20, B: 32, C: 50, D: 80, E: 125, F: 200, G: 315, H: 500 },
  "1.5":  { S1: 5, S2: 8, S3: 13, S4: 20, A: 32, B: 50, C: 80, D: 125, E: 200, F: 315, G: 500, H: 800 },
  "2.5":  { S1: 8, S2: 13, S3: 20, S4: 32, A: 50, B: 80, C: 125, D: 200, E: 315, F: 500, G: 800, H: 1250 },
  "4.0":  { S1: 13, S2: 20, S3: 32, S4: 50, A: 80, B: 125, C: 200, D: 315, E: 500, F: 800, G: 1250, H: 2000 },
};
...
export async function POST(request: Request) {
  try {
    ...
    if (!lotSize) return NextResponse.json({ error: "lotSize is required" }, { status: 400 });
    ...
    return NextResponse.json({ lotSize, aql, inspectionLevel, letterCode: code, sampleSize });
