...
export const INVENTORY_REPORTS: ReportConfig[] = [
  {
    ...
    fields: ['product_name', 'product_sku', 'category', 'quantity', 'unit_cost', 'total_value', 'status'],
    filters: [],
  ...
  },
  {
    ...
    category: ReportCategory.INVENTORY,
    fields: ['product_name', 'product_sku', 'quantity', 'reorder_point', 'reorder_quantity'],
    filters: [
      {
        field: 'status',
  ...
  },
  {
    ...
    category: ReportCategory.INVENTORY,
    fields: ['product_name', 'product_sku', 'category', 'reorder_point', 'reorder_quantity'],
    filters: [
      {
        field: 'status',
  ...
  },
  {
    ...
    grouping: {
      field: 'category',
      aggregations: [
        { field: 'quantity', type: AggregationType.SUM, alias: 'total_quantity' },
        { field: 'total_value', type: AggregationType.SUM, alias: 'total_value' },
      ],
    },
  ...
  },
  {
    ...
    category: ReportCategory.INVENTORY,
    fields: ['product_name', 'product_sku', 'quantity', 'unit_cost', 'total_value'],
    filters: [],
    sorts: [{ field: 'total_value', direction: 'desc' }],
    limit: 20,
  ...
  },
  {
    ...
    category: ReportCategory.INVENTORY,
    fields: ['product_name', 'product_sku', 'quantity', 'reorder_point', 'reorder_quantity', 'unit_cost'],
    filters: [
      {
        field: 'status',
        operator: FilterOperator.EQUALS,
  ...
  },
  {
    ...
    grouping: {
      field: 'category',
      aggregations: [
        { field: 'total_value', type: AggregationType.SUM, alias: 'category_value' },
      ],
    },
    chartType: ChartType.PIE,
  },
...
export const SALES_REPORTS: ReportConfig[] = [
  {
    ...
    fields: ['booking_id', 'customer_name', 'product_name', 'quantity_sold', 'unit_price', 'total_amount', 'booking_date', 'status'],
    filters: [],
  ...
  },
  {
    ...
    grouping: {
      field: 'booking_date',
      aggregations: [
        { field: 'total_amount', type: AggregationType.SUM, alias: 'daily_revenue' },
        { field: 'booking_id', type: AggregationType.COUNT, alias: 'transaction_count' },
      ],
    },
  ...
  },
  {
    ...
    grouping: {
      field: 'product_name',
      aggregations: [
        { field: 'quantity_sold', type: AggregationType.SUM, alias: 'total_quantity' },
        { field: 'total_amount', type: AggregationType.SUM, alias: 'total_revenue' },
      ],
    },
    chartType: ChartType.BAR,
  },
  {
    ...
    grouping: {
      field: 'customer_name',
      aggregations: [
        { field: 'total_amount', type: AggregationType.SUM, alias: 'total_spent' },
        { field: 'booking_id', type: AggregationType.COUNT, alias: 'booking_count' },
      ],
    },
    chartType: ChartType.BAR,
  },
  {
    ...
    grouping: {
      field: 'product_name',
      aggregations: [
        { field: 'quantity_sold', type: AggregationType.SUM, alias: 'total_sold' },
  ...
  },
  {
    ...
    grouping: {
      field: 'booking_date',
      aggregations: [
        { field: 'total_amount', type: AggregationType.SUM, alias: 'monthly_revenue' },
      ],
    },
    chartType: ChartType.LINE,
  },
  {
    ...
    category: ReportCategory.SALES,
    fields: ['booking_id', 'customer_name', 'product_name', 'quantity_sold', 'total_amount', 'booking_date'],
    filters: [
      {
        field: 'status',
        operator: FilterOperator.EQUALS,
  ...
  },
  {
    ...
    category: ReportCategory.SALES,
    fields: ['booking_id', 'customer_name', 'product_name', 'total_amount', 'pickup_date'],
    filters: [
      {
        field: 'status',
        operator: FilterOperator.EQUALS,
...
export const FINANCIAL_REPORTS: ReportConfig[] = [
  {
    ...
    grouping: {
      ...
      aggregations: [
        { field: 'total_amount', type: AggregationType.SUM, alias: 'total_revenue' },
        { field: 'booking_id', type: AggregationType.COUNT, alias: 'transaction_count' },
        { field: 'total_amount', type: AggregationType.AVG, alias: 'average_transaction' },
      ],
    },
    chartType: ChartType.TABLE,
  },
  {
    ...
    category: ReportCategory.FINANCIAL,
    fields: ['product_name', 'unit_cost', 'unit_price', 'quantity', 'total_value'],
    filters: [],
    sorts: [{ field: 'total_value', direction: 'desc' }],
    chartType: ChartType.TABLE,
  },
  ...
  },
  {
    ...
    grouping: {
      field: 'booking_date',
      aggregations: [
        { field: 'total_amount', type: AggregationType.AVG, alias: 'avg_transaction' },
      ],
    },
    chartType: ChartType.LINE,
  },
...
export const CUSTOMER_REPORTS: ReportConfig[] = [
  {
    ...
    fields: ['customer_name', 'email', 'phone', 'total_bookings', 'total_spent', 'last_booking_date'],
    filters: [],
    sorts: [{ field: 'total_spent', direction: 'desc' }],
    chartType: ChartType.TABLE,
  },
...
export const OPERATIONS_REPORTS: ReportConfig[] = [
  {
    ...
    fields: ['pickup_date', 'customer_name', 'product_name', 'quantity_sold', 'booking_id'],
    filters: [
      {
        field: 'status',
        operator: FilterOperator.IN,
  ...
  },
  {
    ...
    grouping: {
      ...
      aggregations: [
        { field: 'booking_id', type: AggregationType.COUNT, alias: 'booking_count' },
        { field: 'quantity_sold', type: AggregationType.SUM, alias: 'items_sold' },
        { field: 'total_amount', type: AggregationType.SUM, alias: 'daily_revenue' },
      ],
    },
    chartType: ChartType.TABLE,
  },
  {
    ...
    category: ReportCategory.OPERATIONS,
    fields: ['booking_id', 'customer_name', 'product_name', 'total_amount', 'booking_date'],
    filters: [
      {
        field: 'status',
        operator: FilterOperator.EQUALS,
...
export function getReportTemplatesByCategory(category: ReportCategory): ReportConfig[] {
  return ALL_REPORT_TEMPLATES.filter((template) => template.category === category);
}
