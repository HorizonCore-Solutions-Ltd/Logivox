...
const nextConfig = {
    ...
    return [
      {
        ...
        headers: [
          ...
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN', // Changed from DENY to allow same-origin iframes
          },
          {
      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: process.env.ALLOWED_ORIGINS || process.env.NEXT_PUBLIC_APP_URL || 'https://flowstock.com',
          },
          {
  ...
  transpilePackages: ['@flowstock/ui', '@flowstock/database', '@flowstock/auth'],
