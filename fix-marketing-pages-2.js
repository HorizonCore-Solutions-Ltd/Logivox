...
const data = {
  "hazmat-compliance": {
    ...
    f1Desc:
      "Automatically prevents incompatible chemical classes from being slotted safely together.",
    f2Title: "SDS Management",
    f2Desc:
      "Digital Safety Data Sheets appended to every related forklift picking task.",
    f3Title: "Incident CAPA",
    f3Desc:
      "Integrated Corrective and Preventive Action logs for immediate warehouse resolution.",
  },
  procurement: {
    ...
    f2Desc:
      "Automatically verify PO, receiving dock counts, and supplier invoices.",
    f3Title: "Automated Reorders",
    f3Desc:
      "Automatically draft purchase orders when safety stock hits critical lows.",
  },
  "iot-telematics": {
    ...
    f1Desc:
      "Instantly log collision events and trigger mandatory vehicle inspections.",
    f2Title: "Access Control",
    f2Desc:
      "Restrict ignition on forklifts to certified, trained personnel only.",
    f3Title: "Battery Analytics",
    f3Desc:
      "Track charge cycles and optimize fleet rotation to prevent mid-shift downs.",
  },
};
